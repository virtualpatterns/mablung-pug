(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-01/comment/04-conditional-comment-browser.cjs
  var require_conditional_comment_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-01/comment/04-conditional-comment-browser-pre.cjs
  "use strict";
  var _conditionalCommentBrowser = _interopRequireDefault2(require_conditional_comment_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _conditionalCommentBrowser.default)(local);
