(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/02-each-keys.cjs
  var require_each_keys = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/02-each-keys-pre-bundle.cjs
  "use strict";
  var _eachKeys = _interopRequireDefault2(require_each_keys());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let div = document.querySelector("body div");
  let node = (0, _eachKeys.default)({});
