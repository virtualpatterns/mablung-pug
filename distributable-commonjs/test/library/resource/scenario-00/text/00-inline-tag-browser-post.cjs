(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/00-inline-tag-browser.cjs
  var require_inline_tag_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/00-inline-tag-browser-pre.cjs
  "use strict";
  var _inlineTagBrowser = _interopRequireDefault2(require_inline_tag_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _inlineTagBrowser.default)(local);
