(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/miscellaneous/00-id-browser.cjs
  var require_id_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/miscellaneous/00-id-browser-pre.cjs
  "use strict";
  var _idBrowser = _interopRequireDefault2(require_id_browser());
