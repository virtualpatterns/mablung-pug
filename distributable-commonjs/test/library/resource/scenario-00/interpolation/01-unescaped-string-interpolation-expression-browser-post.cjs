(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/01-unescaped-string-interpolation-expression-browser.cjs
  var require_unescaped_string_interpolation_expression_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/01-unescaped-string-interpolation-expression-browser-pre.cjs
  "use strict";
  var _unescapedStringInterpolationExpressionBrowser = _interopRequireDefault2(require_unescaped_string_interpolation_expression_browser());
