(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/tag/01-block-expansion-browser.cjs
  var require_block_expansion_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/tag/01-block-expansion-browser-pre.cjs
  "use strict";
  var _blockExpansionBrowser = _interopRequireDefault2(require_block_expansion_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _blockExpansionBrowser.default)(local);
