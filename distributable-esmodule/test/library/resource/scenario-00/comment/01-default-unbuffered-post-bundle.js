(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/comment/01-default-unbuffered.js
  ...
  function default_unbuffered_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/comment/01-default-unbuffered-pre-bundle.js
  let div = document.querySelector("body div");
  let node = default_unbuffered_default({});
