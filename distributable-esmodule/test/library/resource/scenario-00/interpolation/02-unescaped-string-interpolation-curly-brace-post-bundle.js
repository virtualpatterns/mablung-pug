(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/interpolation/02-unescaped-string-interpolation-curly-brace.js
  ...
  function unescaped_string_interpolation_curly_brace_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/interpolation/02-unescaped-string-interpolation-curly-brace-pre-bundle.js
  let div = document.querySelector("body div");
  let node = unescaped_string_interpolation_curly_brace_default({});
