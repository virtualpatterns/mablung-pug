(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/16-and-attribute.cjs
  var require_and_attribute = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/16-and-attribute-pre-bundle.cjs
  "use strict";
  var _andAttribute = _interopRequireDefault2(require_and_attribute());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let div = document.querySelector("body div");
  let node = (0, _andAttribute.default)({});
