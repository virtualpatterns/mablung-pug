(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/mixin/02-mixin-block-browser.js
    ...
    function __getNode2(__utility2 = {}) {
      ...
      function __mixin__article(attribute, block, title) {
        ...
        __utility2.addNode(__utility2.createNode("div", (() => {
          const __attribute = {};
          __utility2.addAttribute("class", "article", __attribute);
          return __attribute;
        })(), (() => {
          const __node3 = [];
          __utility2.addNode(__utility2.createNode("div", (() => {
            const __attribute = {};
            __utility2.addAttribute("class", "article-wrapper", __attribute);
            return __attribute;
          })(), (() => {
            const __node4 = [];
            __utility2.addNode(__utility2.createNode("h1", {}, (() => {
              const __node5 = [];
              {
                let value = title;
                if (typeof value === "string") {
                  __utility2.addNode(__utility2.convertToNode(value), __node5);
                } else {
                  __utility2.addNode(value, __node5);
                }
              }
              return __node5;
            })()), __node4);
            if (block) {
              __utility2.addNode(block, __node4);
            } else {
              __utility2.addNode(__utility2.createNode("p", {}, (() => {
                const __node5 = [];
                __utility2.addNode(__utility2.convertToNode("No content provided"), __node5);
                return __node5;
              })()), __node4);
            }
            return __node4;
      ...
      __utility2.addNode(__mixin__article(void 0, void 0, "Hello world"), __node);
      __utility2.addNode(__mixin__article(void 0, (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.createNode("p", {}, (() => {
          const __node3 = [];
          __utility2.addNode(__utility2.convertToNode("This is my"), __node3);
          return __node3;
        })()), __node2);
        __utility2.addNode(__utility2.createNode("p", {}, (() => {
          const __node3 = [];
          __utility2.addNode(__utility2.convertToNode("Amazing article"), __node3);
          return __node3;
        })()), __node2);
        return __node2;
      })(), "Hello world"), __node);
  ...
  function mixin_block_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/mixin/02-mixin-block-browser-pre.js
  let local = {};
  let node = mixin_block_browser_default(local);
