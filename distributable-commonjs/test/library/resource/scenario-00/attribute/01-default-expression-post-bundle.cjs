(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/01-default-expression.cjs
  var require_default_expression = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/01-default-expression-pre-bundle.cjs
  "use strict";
  var _defaultExpression = _interopRequireDefault2(require_default_expression());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let div = document.querySelector("body div");
  let node = (0, _defaultExpression.default)({});
