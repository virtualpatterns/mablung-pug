(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/inheritance/01-additional-block-browser.js
  ...
  function additional_block_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/inheritance/01-additional-block-browser-pre.js
  let local = {};
  let node = additional_block_browser_default(local);
