(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/interpolation/03-unescaped-string-interpolation-meta.js
  ...
  function unescaped_string_interpolation_meta_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/interpolation/03-unescaped-string-interpolation-meta-pre-bundle.js
  let div = document.querySelector("body div");
  let node = unescaped_string_interpolation_meta_default({});
