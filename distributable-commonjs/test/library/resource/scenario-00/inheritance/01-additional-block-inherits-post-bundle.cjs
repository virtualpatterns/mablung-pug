(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/01-additional-block-inherits.cjs
  var require_additional_block_inherits = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/01-additional-block-inherits-pre-bundle.cjs
  "use strict";
  var _additionalBlockInherits = _interopRequireDefault2(require_additional_block_inherits());
