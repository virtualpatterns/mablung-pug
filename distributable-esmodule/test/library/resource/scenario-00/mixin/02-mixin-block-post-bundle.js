(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/mixin/02-mixin-block.js
  ...
  function mixin_block_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/mixin/02-mixin-block-pre-bundle.js
  let div = document.querySelector("body div");
  let node = mixin_block_default({});
