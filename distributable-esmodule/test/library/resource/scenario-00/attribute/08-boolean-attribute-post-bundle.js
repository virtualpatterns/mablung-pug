(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/attribute/08-boolean-attribute.js
  ...
  function boolean_attribute_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/attribute/08-boolean-attribute-pre-bundle.js
  let div = document.querySelector("body div");
  let node = boolean_attribute_default({});
