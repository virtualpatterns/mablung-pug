(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/mixin/06-rest-arguments-browser.js
    ...
    function __getNode2(__utility2 = {}) {
      ...
      function __mixin__list(attribute, block, id, ...items) {
        ...
        __utility2.addNode(__utility2.createNode("ul", (() => {
          const __attribute = {};
          __utility2.addAttribute("id", id, __attribute);
          return __attribute;
        })(), (() => {
          const __node3 = [];
          __utility2.forEach(items, (item) => {
      ...
      __utility2.addNode(__mixin__list(void 0, void 0, "my-list", 1, 2, 3, 4), __node);
      return __utility2.getNode(__node);
    }
    return __getNode2(__utility);
  }
  function rest_arguments_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/mixin/06-rest-arguments-browser-pre.js
  let local = {};
  let node = rest_arguments_browser_default(local);
