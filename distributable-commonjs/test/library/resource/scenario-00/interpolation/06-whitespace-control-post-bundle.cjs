(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/06-whitespace-control.cjs
  var require_whitespace_control = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/06-whitespace-control-pre-bundle.cjs
  "use strict";
  var _whitespaceControl = _interopRequireDefault2(require_whitespace_control());
