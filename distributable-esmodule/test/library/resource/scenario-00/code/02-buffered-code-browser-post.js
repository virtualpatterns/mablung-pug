(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/code/02-buffered-code-browser.js
  ...
  function buffered_code_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/code/02-buffered-code-browser-pre.js
  let local = {};
  let node = buffered_code_browser_default(local);
