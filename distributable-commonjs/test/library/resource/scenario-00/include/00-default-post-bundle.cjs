(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/include/00-default.cjs
  var require_default2 = __commonJS((exports2) => {
    ...
    function _default2(__local = {}, __utility = _utility.Utility) {
      return __getNode(__local, __utility);
    }
  });

  // distributable-commonjs/test/library/resource/scenario-00/include/00-default-pre-bundle.cjs
  "use strict";
  var _default = _interopRequireDefault2(require_default2());
