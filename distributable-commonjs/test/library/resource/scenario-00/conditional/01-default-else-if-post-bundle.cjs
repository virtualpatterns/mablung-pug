(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/conditional/01-default-else-if.cjs
  var require_default_else_if = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/conditional/01-default-else-if-pre-bundle.cjs
  "use strict";
  var _defaultElseIf = _interopRequireDefault2(require_default_else_if());
