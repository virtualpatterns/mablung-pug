(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/case/01-case-fall-through-browser.cjs
  var require_case_fall_through_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/case/01-case-fall-through-browser-pre.cjs
  "use strict";
  var _caseFallThroughBrowser = _interopRequireDefault2(require_case_fall_through_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _caseFallThroughBrowser.default)(local);
