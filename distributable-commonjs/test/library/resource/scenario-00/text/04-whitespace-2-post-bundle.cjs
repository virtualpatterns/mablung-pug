(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/04-whitespace-2.cjs
  var require_whitespace_2 = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/04-whitespace-2-pre-bundle.cjs
  "use strict";
  var _whitespace = _interopRequireDefault2(require_whitespace_2());
