(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/code/03-buffered-inline-code-browser.cjs
  var require_buffered_inline_code_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/code/03-buffered-inline-code-browser-pre.cjs
  "use strict";
  var _bufferedInlineCodeBrowser = _interopRequireDefault2(require_buffered_inline_code_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _bufferedInlineCodeBrowser.default)(local);
