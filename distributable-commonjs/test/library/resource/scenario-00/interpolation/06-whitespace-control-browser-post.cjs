(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/06-whitespace-control-browser.cjs
  var require_whitespace_control_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/06-whitespace-control-browser-pre.cjs
  "use strict";
  var _whitespaceControlBrowser = _interopRequireDefault2(require_whitespace_control_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _whitespaceControlBrowser.default)(local);
