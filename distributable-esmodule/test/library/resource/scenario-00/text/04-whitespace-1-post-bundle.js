(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/text/04-whitespace-1.js
  ...
  function whitespace_1_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/text/04-whitespace-1-pre-bundle.js
  let div = document.querySelector("body div");
  let node = whitespace_1_default({});
