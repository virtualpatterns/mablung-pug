(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/inheritance/02-block-append-prepend-browser.js
  ...
  function block_append_prepend_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/inheritance/02-block-append-prepend-browser-pre.js
  let local = {};
  let node = block_append_prepend_browser_default(local);
