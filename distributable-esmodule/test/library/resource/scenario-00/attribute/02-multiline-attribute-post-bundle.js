(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/attribute/02-multiline-attribute.js
  ...
  function multiline_attribute_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/attribute/02-multiline-attribute-pre-bundle.js
  let div = document.querySelector("body div");
  let node = multiline_attribute_default({});
