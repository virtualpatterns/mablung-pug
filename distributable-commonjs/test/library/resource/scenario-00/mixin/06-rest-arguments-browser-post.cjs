(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/06-rest-arguments-browser.cjs
  var require_rest_arguments_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/06-rest-arguments-browser-pre.cjs
  "use strict";
  var _restArgumentsBrowser = _interopRequireDefault2(require_rest_arguments_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _restArgumentsBrowser.default)(local);
