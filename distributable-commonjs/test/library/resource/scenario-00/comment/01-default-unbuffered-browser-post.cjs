(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/comment/01-default-unbuffered-browser.cjs
  var require_default_unbuffered_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/comment/01-default-unbuffered-browser-pre.cjs
  "use strict";
  var _defaultUnbufferedBrowser = _interopRequireDefault2(require_default_unbuffered_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _defaultUnbufferedBrowser.default)(local);
