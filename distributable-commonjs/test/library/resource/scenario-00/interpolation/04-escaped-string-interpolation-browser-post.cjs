(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/04-escaped-string-interpolation-browser.cjs
  var require_escaped_string_interpolation_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/04-escaped-string-interpolation-browser-pre.cjs
  "use strict";
  var _escapedStringInterpolationBrowser = _interopRequireDefault2(require_escaped_string_interpolation_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _escapedStringInterpolationBrowser.default)(local);
