(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/tag/00-default-browser.js
    ...
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("ul", {}, (() => {
        ...
        __utility2.addNode(__utility2.createNode("li", {}, (() => {
          const __node3 = [];
          __utility2.addNode(__utility2.convertToNode("Item A"), __node3);
          return __node3;
        })()), __node2);
        __utility2.addNode(__utility2.createNode("li", {}, (() => {
          const __node3 = [];
          __utility2.addNode(__utility2.convertToNode("Item B"), __node3);
          return __node3;
        })()), __node2);
        __utility2.addNode(__utility2.createNode("li", {}, (() => {
          const __node3 = [];
          __utility2.addNode(__utility2.convertToNode("Item C"), __node3);
          return __node3;
        })()), __node2);
        return __node2;
      })()), __node);
  ...
  // distributable-esmodule/test/library/resource/scenario-00/tag/00-default-browser-pre.js
  let local = {};
