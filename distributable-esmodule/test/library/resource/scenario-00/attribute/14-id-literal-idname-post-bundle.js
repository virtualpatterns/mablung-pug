(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/attribute/14-id-literal-idname.js
  ...
  function id_literal_idname_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/attribute/14-id-literal-idname-pre-bundle.js
  let div = document.querySelector("body div");
  let node = id_literal_idname_default({});
