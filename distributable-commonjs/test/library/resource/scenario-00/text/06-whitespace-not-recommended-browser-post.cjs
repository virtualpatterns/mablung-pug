(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/06-whitespace-not-recommended-browser.cjs
  var require_whitespace_not_recommended_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/06-whitespace-not-recommended-browser-pre.cjs
  "use strict";
  var _whitespaceNotRecommendedBrowser = _interopRequireDefault2(require_whitespace_not_recommended_browser());
