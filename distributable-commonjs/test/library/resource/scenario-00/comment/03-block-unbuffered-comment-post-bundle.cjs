(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/comment/03-block-unbuffered-comment.cjs
  var require_block_unbuffered_comment = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/comment/03-block-unbuffered-comment-pre-bundle.cjs
  "use strict";
  var _blockUnbufferedComment = _interopRequireDefault2(require_block_unbuffered_comment());
