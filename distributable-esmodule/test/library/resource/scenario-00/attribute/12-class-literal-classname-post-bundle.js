(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/attribute/12-class-literal-classname.js
  ...
  function class_literal_classname_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/attribute/12-class-literal-classname-pre-bundle.js
  let div = document.querySelector("body div");
  let node = class_literal_classname_default({});
