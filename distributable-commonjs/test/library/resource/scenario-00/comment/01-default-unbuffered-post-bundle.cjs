(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/comment/01-default-unbuffered.cjs
  var require_default_unbuffered = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/comment/01-default-unbuffered-pre-bundle.cjs
  "use strict";
  var _defaultUnbuffered = _interopRequireDefault2(require_default_unbuffered());
