(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-01/filter/02-nested-filter-browser.cjs
  var require_nested_filter_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-01/filter/02-nested-filter-browser-pre.cjs
  "use strict";
  var _nestedFilterBrowser = _interopRequireDefault2(require_nested_filter_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _nestedFilterBrowser.default)(local);
