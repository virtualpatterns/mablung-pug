(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/03-mixin-attributes-browser.cjs
  var require_mixin_attributes_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/03-mixin-attributes-browser-pre.cjs
  "use strict";
  var _mixinAttributesBrowser = _interopRequireDefault2(require_mixin_attributes_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _mixinAttributesBrowser.default)(local);
