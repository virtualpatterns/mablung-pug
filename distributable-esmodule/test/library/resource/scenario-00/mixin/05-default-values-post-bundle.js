(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/mixin/05-default-values.js
  ...
  function default_values_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/mixin/05-default-values-pre-bundle.js
  let div = document.querySelector("body div");
  let node = default_values_default({});
