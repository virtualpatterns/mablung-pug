(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-01/filter/02-nested-filter.cjs
  var require_nested_filter = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-01/filter/02-nested-filter-pre-bundle.cjs
  "use strict";
  var _nestedFilter = _interopRequireDefault2(require_nested_filter());
