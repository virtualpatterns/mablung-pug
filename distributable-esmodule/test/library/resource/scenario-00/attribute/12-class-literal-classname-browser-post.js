(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/attribute/12-class-literal-classname-browser.js
  ...
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("a", (() => {
        const __attribute = {};
        __utility2.addAttribute("class", "button", __attribute);
        return __attribute;
      })(), []), __node);
  ...
  function class_literal_classname_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/attribute/12-class-literal-classname-browser-pre.js
  let local = {};
  let node = class_literal_classname_browser_default(local);
