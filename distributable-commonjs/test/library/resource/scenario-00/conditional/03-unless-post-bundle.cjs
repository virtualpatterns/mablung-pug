(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/conditional/03-unless.cjs
  var require_unless = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/conditional/03-unless-pre-bundle.cjs
  "use strict";
  var _unless = _interopRequireDefault2(require_unless());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let div = document.querySelector("body div");
  let node = (0, _unless.default)({});
