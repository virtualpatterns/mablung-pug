(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/00-inline-tag.cjs
  var require_inline_tag = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/00-inline-tag-pre-bundle.cjs
  "use strict";
  var _inlineTag = _interopRequireDefault2(require_inline_tag());
