(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/include/00-default-head-browser.cjs
  var require_default_head_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/include/00-default-head-browser-pre.cjs
  "use strict";
  var _defaultHeadBrowser = _interopRequireDefault2(require_default_head_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _defaultHeadBrowser.default)(local);
