(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/miscellaneous/01-class.cjs
  var require_class = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/miscellaneous/01-class-pre-bundle.cjs
  "use strict";
