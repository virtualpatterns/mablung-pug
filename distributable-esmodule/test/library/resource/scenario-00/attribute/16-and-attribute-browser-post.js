(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/attribute/16-and-attribute-browser.js
  ...
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("div", (() => {
        const __attribute = {};
        __utility2.addAttribute("id", "foo", __attribute);
        __utility2.addAttribute("data-bar", "foo", __attribute);
        __utility2.addAndAttribute({"data-foo": "bar"}, __attribute);
        return __attribute;
      })(), []), __node);
  ...
  function and_attribute_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/attribute/16-and-attribute-browser-pre.js
  let local = {};
  let node = and_attribute_browser_default(local);
