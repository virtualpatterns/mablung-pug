(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/02-piped-text.cjs
  var require_piped_text = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/02-piped-text-pre-bundle.cjs
  "use strict";
  var _pipedText = _interopRequireDefault2(require_piped_text());
