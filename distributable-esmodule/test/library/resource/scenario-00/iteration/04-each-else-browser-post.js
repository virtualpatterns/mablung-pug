(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/iteration/04-each-else-browser.js
  ...
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("ul", {}, (() => {
        const __node2 = [];
        if (__utility2.forEach(values, (val) => {
          ...
          __utility2.addNode(__utility2.createNode("li", {}, (() => {
            const __node3 = [];
            __utility2.addNode(__utility2.convertToNode("There are no values"), __node3);
            return __node3;
          })()), __node2);
        }
        return __node2;
  ...
  function each_else_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/iteration/04-each-else-browser-pre.js
  let local = {};
  let node = each_else_browser_default(local);
