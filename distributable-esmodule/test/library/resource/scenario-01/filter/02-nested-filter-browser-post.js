(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-01/filter/02-nested-filter-browser.js
  ...
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("script", {}, (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.convertToNode("//<![CDATA[\nconst myFunc = () => `This is ES2015 in a CD${'ATA'}`;\n//]]>"), __node2);
        return __node2;
      })()), __node);
  ...
  function nested_filter_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-01/filter/02-nested-filter-browser-pre.js
  let local = {};
  let node = nested_filter_browser_default(local);
