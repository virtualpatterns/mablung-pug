(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/06-attribute-interpolation-template.cjs
  var require_attribute_interpolation_template = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/06-attribute-interpolation-template-pre-bundle.cjs
  "use strict";
  var _attributeInterpolationTemplate = _interopRequireDefault2(require_attribute_interpolation_template());
