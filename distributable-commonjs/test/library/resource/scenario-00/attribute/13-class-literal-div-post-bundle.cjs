(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/13-class-literal-div.cjs
  var require_class_literal_div = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/13-class-literal-div-pre-bundle.cjs
  "use strict";
  var _classLiteralDiv = _interopRequireDefault2(require_class_literal_div());
