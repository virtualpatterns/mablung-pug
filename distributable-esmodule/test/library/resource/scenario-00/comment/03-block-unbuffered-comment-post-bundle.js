(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/comment/03-block-unbuffered-comment.js
  ...
  function block_unbuffered_comment_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/comment/03-block-unbuffered-comment-pre-bundle.js
  let div = document.querySelector("body div");
  let node = block_unbuffered_comment_default({});
