(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/03-block-tag-1.cjs
  var require_block_tag_1 = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/03-block-tag-1-pre-bundle.cjs
  "use strict";
  var _blockTag = _interopRequireDefault2(require_block_tag_1());
