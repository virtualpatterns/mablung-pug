(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/00-each-browser.cjs
  var require_each_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/00-each-browser-pre.cjs
  "use strict";
  var _eachBrowser = _interopRequireDefault2(require_each_browser());
