(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/01-default-arguments-browser.cjs
  var require_default_arguments_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/01-default-arguments-browser-pre.cjs
  "use strict";
  var _defaultArgumentsBrowser = _interopRequireDefault2(require_default_arguments_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _defaultArgumentsBrowser.default)(local);
