(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/inheritance/02-block-append-prepend-inherits-optional-browser.js
      ...
      __utility2.addNode(__utility2.createNode("html", {}, (() => {
        ...
        __utility2.addNode(__utility2.createNode("head", {}, (() => {
          ...
          __utility2.addNode(__utility2.createNode("script", (() => {
            const __attribute = {};
            __utility2.addAttribute("src", "/vendor/three.js", __attribute);
            return __attribute;
          })(), []), __node3);
          __utility2.addNode(__utility2.createNode("script", (() => {
            const __attribute = {};
            __utility2.addAttribute("src", "/game.js", __attribute);
            return __attribute;
          })(), []), __node3);
          __utility2.addNode(__utility2.createNode("script", (() => {
            const __attribute = {};
            __utility2.addAttribute("src", "/vendor/jquery.js", __attribute);
            return __attribute;
          })(), []), __node3);
          __utility2.addNode(__utility2.createNode("script", (() => {
            const __attribute = {};
            __utility2.addAttribute("src", "/vendor/caustic.js", __attribute);
            return __attribute;
          })(), []), __node3);
          return __node3;
        })()), __node2);
  ...
  function block_append_prepend_inherits_optional_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/inheritance/02-block-append-prepend-inherits-optional-browser-pre.js
  let local = {};
  let node = block_append_prepend_inherits_optional_browser_default(local);
