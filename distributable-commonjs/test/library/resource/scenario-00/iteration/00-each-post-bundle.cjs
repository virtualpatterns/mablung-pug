(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/00-each.cjs
  var require_each = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/00-each-pre-bundle.cjs
  "use strict";
  var _each = _interopRequireDefault2(require_each());
