(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/conditional/03-unless.js
  ...
  function unless_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/conditional/03-unless-pre-bundle.js
  let div = document.querySelector("body div");
  let node = unless_default({});
