(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/text/02-piped-text-browser.js
  ...
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("p", {}, (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.convertToNode("The pipe always goes at the beginning of its own line,"), __node2);
        __utility2.addNode("\n", __node2);
        __utility2.addNode(__utility2.convertToNode("not counting indentation."), __node2);
        return __node2;
      })()), __node);
  ...
  function piped_text_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/text/02-piped-text-browser-pre.js
  let local = {};
  let node = piped_text_browser_default(local);
