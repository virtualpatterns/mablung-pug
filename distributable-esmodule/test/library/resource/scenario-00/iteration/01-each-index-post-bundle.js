(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/iteration/01-each-index.js
  ...
  function each_index_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/iteration/01-each-index-pre-bundle.js
  let div = document.querySelector("body div");
  let node = each_index_default({});
