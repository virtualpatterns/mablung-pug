(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/include/00-default-head-browser.js
    ...
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("head", {}, (() => {
        ...
        __utility2.addNode(__utility2.createNode("title", {}, (() => {
          const __node3 = [];
          __utility2.addNode(__utility2.convertToNode("My Site"), __node3);
          return __node3;
        })()), __node2);
  ...
  function default_head_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/include/00-default-head-browser-pre.js
  let local = {};
  let node = default_head_browser_default(local);
