(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/02-block-append-prepend-browser.cjs
  var require_block_append_prepend_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/02-block-append-prepend-browser-pre.cjs
  "use strict";
  var _blockAppendPrependBrowser = _interopRequireDefault2(require_block_append_prepend_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _blockAppendPrependBrowser.default)(local);
