(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/attribute/13-class-literal-div.js
  ...
  function class_literal_div_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/attribute/13-class-literal-div-pre-bundle.js
  let div = document.querySelector("body div");
  let node = class_literal_div_default({});
