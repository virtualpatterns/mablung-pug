(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/attribute/08-boolean-attribute-browser.js
  ...
  function boolean_attribute_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/attribute/08-boolean-attribute-browser-pre.js
  let local = {};
  let node = boolean_attribute_browser_default(local);
