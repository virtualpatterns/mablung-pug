(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/interpolation/01-unescaped-string-interpolation-expression-browser.js
  ...
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("p", {}, (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.convertToNode("This is "), __node2);
        {
  ...
  function unescaped_string_interpolation_expression_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/interpolation/01-unescaped-string-interpolation-expression-browser-pre.js
  let local = {};
  let node = unescaped_string_interpolation_expression_browser_default(local);
