(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/iteration/05-while-browser.js
  ...
  function while_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/iteration/05-while-browser-pre.js
  let local = {};
  let node = while_browser_default(local);
