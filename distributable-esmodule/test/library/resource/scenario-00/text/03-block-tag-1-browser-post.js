(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/text/03-block-tag-1-browser.js
  ...
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("script", {}, (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.convertToNode("if (usingPug)"), __node2);
        __utility2.addNode("\n", __node2);
        __utility2.addNode(__utility2.convertToNode("  console.log('you are awesome')"), __node2);
        __utility2.addNode("\n", __node2);
        __utility2.addNode(__utility2.convertToNode("else"), __node2);
        __utility2.addNode("\n", __node2);
        __utility2.addNode(__utility2.convertToNode("  console.log('use pug')"), __node2);
        return __node2;
      })()), __node);
  ...
  function block_tag_1_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/text/03-block-tag-1-browser-pre.js
  let local = {};
  let node = block_tag_1_browser_default(local);
