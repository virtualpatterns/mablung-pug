(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/attribute/02-multiline-attribute-browser.js
  const utility = __toModule(require_utility());
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      const __node = [];
      __utility2.addNode(__utility2.createNode("input", (() => {
        const __attribute = {};
        __utility2.addAttribute("type", "checkbox", __attribute);
        __utility2.addAttribute("name", "agreement", __attribute);
        __utility2.addAttribute("checked", true, __attribute);
        return __attribute;
      })(), []), __node);
  ...
  function multiline_attribute_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/attribute/02-multiline-attribute-browser-pre.js
  let local = {};
  let node = multiline_attribute_browser_default(local);
