(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/filter/01-inline-syntax.cjs
  var require_inline_syntax = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/filter/01-inline-syntax-pre-bundle.cjs
  "use strict";
  var _inlineSyntax = _interopRequireDefault2(require_inline_syntax());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let div = document.querySelector("body div");
  let node = (0, _inlineSyntax.default)({});
