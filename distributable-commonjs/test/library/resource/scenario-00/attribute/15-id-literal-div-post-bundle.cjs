(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/15-id-literal-div.cjs
  var require_id_literal_div = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/15-id-literal-div-pre-bundle.cjs
  "use strict";
  var _idLiteralDiv = _interopRequireDefault2(require_id_literal_div());
