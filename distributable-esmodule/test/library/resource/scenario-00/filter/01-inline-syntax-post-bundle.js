(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/filter/01-inline-syntax.js
  ...
  function inline_syntax_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/filter/01-inline-syntax-pre-bundle.js
  let div = document.querySelector("body div");
  let node = inline_syntax_default({});
