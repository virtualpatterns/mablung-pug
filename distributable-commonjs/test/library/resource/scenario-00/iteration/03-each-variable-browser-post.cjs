(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/03-each-variable-browser.cjs
  var require_each_variable_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/03-each-variable-browser-pre.cjs
  "use strict";
  var _eachVariableBrowser = _interopRequireDefault2(require_each_variable_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _eachVariableBrowser.default)(local);
