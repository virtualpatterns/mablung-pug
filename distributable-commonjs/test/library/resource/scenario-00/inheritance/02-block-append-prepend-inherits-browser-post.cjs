(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/02-block-append-prepend-inherits-browser.cjs
  var require_block_append_prepend_inherits_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/02-block-append-prepend-inherits-browser-pre.cjs
  "use strict";
  var _blockAppendPrependInheritsBrowser = _interopRequireDefault2(require_block_append_prepend_inherits_browser());
