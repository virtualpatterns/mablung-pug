(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/05-whitespace-recommended-2-browser.cjs
  var require_whitespace_recommended_2_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/05-whitespace-recommended-2-browser-pre.cjs
  "use strict";
  var _whitespaceRecommended2Browser = _interopRequireDefault2(require_whitespace_recommended_2_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _whitespaceRecommended2Browser.default)(local);
