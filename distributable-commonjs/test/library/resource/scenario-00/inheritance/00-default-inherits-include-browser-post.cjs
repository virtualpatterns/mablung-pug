(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/00-default-inherits-include-browser.cjs
  var require_default_inherits_include_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/00-default-inherits-include-browser-pre.cjs
  "use strict";
  var _defaultInheritsIncludeBrowser = _interopRequireDefault2(require_default_inherits_include_browser());
