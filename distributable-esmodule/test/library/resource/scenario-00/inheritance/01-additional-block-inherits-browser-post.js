(() => {
  ...
  var require_utility = __commonJS((exports) => {
    ...
    const hyperscript = __toModule(require_hyperscript());
    const clone = __toModule(require_clone());
    const ModuleConvert = __toModule(require_build());
    const is_node = __toModule(require_is_node());
    const {htmlToHs2: Convert} = ModuleConvert.default || ModuleConvert;
    class Utility {
      static create(...parameter) {
        return hyperscript.default(...parameter);
      }
      ...
      static getNodeProperty(property) {
        let _property = clone.default(property);
        let _attribute = property.attributes ? clone.default(property.attributes) : {};
        let map = {
          class: "className",
          colspan: "colSpan",
          for: "htmlFor",
        ...
        Object.entries(_property).filter(([name]) => /^\((.*?)\)$/.test(name) || is_node.default && /^data-(.*?)$/.test(name) || name === "checked").forEach(([name, value]) => {
          _attribute[name] = value;
          delete _property[name];
        });
        if (is_node.default && !Array.isArray(_attribute)) {
          _attribute = Object.entries(_attribute).sort(([leftName], [rightName]) => leftName.localeCompare(rightName)).map(([name, value]) => ({name, value}));
        }
        _property[is_node.default ? "attributes" : "attrs"] = _attribute;
        return _property;
      }
  ...
  // distributable-esmodule/test/library/resource/scenario-00/inheritance/01-additional-block-inherits-browser.js
  const utility = __toModule(require_utility());
  function __getNode(__local = {}, __utility = {}) {
    const {title} = __local;
    function __getNode2(__utility2 = {}) {
      const __node = [];
      __utility2.addNode(__utility2.createNode("html", {}, (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.createNode("head", {}, (() => {
          const __node3 = [];
          __utility2.addNode(__utility2.createNode("title", {}, (() => {
            const __node4 = [];
            __utility2.addNode(__utility2.convertToNode("My Site - "), __node4);
            {
              let value = title;
              if (typeof value === "string") {
                __utility2.addNode(__utility2.convertToNode(value), __node4);
              } else {
                __utility2.addNode(value, __node4);
              }
            }
            return __node4;
          })()), __node3);
          __utility2.addNode(__utility2.createNode("script", (() => {
            const __attribute = {};
            __utility2.addAttribute("src", "/jquery.js", __attribute);
            return __attribute;
          })(), []), __node3);
          return __node3;
        })()), __node2);
        __utility2.addNode(__utility2.createNode("body", {}, (() => {
          const __node3 = [];
          __utility2.addNode(__utility2.createNode("div", (() => {
            const __attribute = {};
            __utility2.addAttribute("class", "sidebar", __attribute);
            return __attribute;
          })(), (() => {
            const __node4 = [];
            __utility2.addNode(__utility2.createNode("p", {}, (() => {
              const __node5 = [];
              __utility2.addNode(__utility2.convertToNode("nothing"), __node5);
              return __node5;
            })()), __node4);
            return __node4;
          })()), __node3);
          __utility2.addNode(__utility2.createNode("div", (() => {
            const __attribute = {};
            __utility2.addAttribute("class", "primary", __attribute);
            return __attribute;
          })(), (() => {
            const __node4 = [];
            __utility2.addNode(__utility2.createNode("p", {}, (() => {
          ...
          __utility2.addNode(__utility2.createNode("div", (() => {
            const __attribute = {};
            __utility2.addAttribute("id", "footer", __attribute);
            return __attribute;
          })(), (() => {
            const __node4 = [];
            __utility2.addNode(__utility2.createNode("p", {}, (() => {
              const __node5 = [];
              __utility2.addNode(__utility2.convertToNode("some footer content"), __node5);
              return __node5;
            })()), __node4);
            return __node4;
          })()), __node3);
  ...
  function additional_block_inherits_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/inheritance/01-additional-block-inherits-browser-pre.js
  let local = {};
  let node = additional_block_inherits_browser_default(local);
