(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/05-whitespace-recommended-1-browser.cjs
  var require_whitespace_recommended_1_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/05-whitespace-recommended-1-browser-pre.cjs
  "use strict";
  var _whitespaceRecommended1Browser = _interopRequireDefault2(require_whitespace_recommended_1_browser());
