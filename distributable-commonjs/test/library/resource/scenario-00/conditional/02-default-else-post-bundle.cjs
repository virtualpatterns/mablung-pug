(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/conditional/02-default-else.cjs
  var require_default_else = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/conditional/02-default-else-pre-bundle.cjs
  "use strict";
  var _defaultElse = _interopRequireDefault2(require_default_else());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let div = document.querySelector("body div");
  let node = (0, _defaultElse.default)({});
