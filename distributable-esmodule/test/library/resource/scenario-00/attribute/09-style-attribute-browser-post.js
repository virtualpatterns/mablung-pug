(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/attribute/09-style-attribute-browser.js
  ...
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("a", (() => {
        const __attribute = {};
        __utility2.addAttribute("style", {color: "red", background: "green"}, __attribute);
        return __attribute;
      })(), []), __node);
  ...
  function style_attribute_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/attribute/09-style-attribute-browser-pre.js
  let local = {};
  let node = style_attribute_browser_default(local);
