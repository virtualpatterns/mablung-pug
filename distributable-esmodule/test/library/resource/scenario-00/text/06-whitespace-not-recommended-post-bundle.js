(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/text/06-whitespace-not-recommended.js
  ...
  function whitespace_not_recommended_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/text/06-whitespace-not-recommended-pre-bundle.js
  let div = document.querySelector("body div");
  let node = whitespace_not_recommended_default({});
