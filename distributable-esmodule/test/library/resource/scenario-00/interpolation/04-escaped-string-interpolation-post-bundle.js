(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/interpolation/04-escaped-string-interpolation.js
  ...
  function escaped_string_interpolation_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/interpolation/04-escaped-string-interpolation-pre-bundle.js
  let div = document.querySelector("body div");
  let node = escaped_string_interpolation_default({});
