(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/code/00-unbuffered-code.cjs
  var require_unbuffered_code = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/code/00-unbuffered-code-pre-bundle.cjs
  "use strict";
  var _unbufferedCode = _interopRequireDefault2(require_unbuffered_code());
