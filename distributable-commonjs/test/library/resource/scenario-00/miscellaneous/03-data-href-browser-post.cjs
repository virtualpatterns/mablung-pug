(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/miscellaneous/03-data-href-browser.cjs
  var require_data_href_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/miscellaneous/03-data-href-browser-pre.cjs
  "use strict";
  var _dataHrefBrowser = _interopRequireDefault2(require_data_href_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _dataHrefBrowser.default)(local);
