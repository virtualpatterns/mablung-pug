(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/00-default.cjs
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/00-default-pre-bundle.cjs
  "use strict";
