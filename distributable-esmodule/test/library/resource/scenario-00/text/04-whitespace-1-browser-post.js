(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/text/04-whitespace-1-browser.js
  const utility = __toModule(require_utility());
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      const __node = [];
      __utility2.addNode(__utility2.convertToNode("You put the em"), __node);
      __utility2.addNode(__utility2.createNode("em", {}, (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.convertToNode("pha"), __node2);
        return __node2;
      })()), __node);
      __utility2.addNode(__utility2.convertToNode("sis on the wrong syl"), __node);
      __utility2.addNode(__utility2.createNode("em", {}, (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.convertToNode("la"), __node2);
        return __node2;
      })()), __node);
      __utility2.addNode(__utility2.convertToNode("ble."), __node);
      return __utility2.getNode(__node);
    }
    return __getNode2(__utility);
  }
  function whitespace_1_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/text/04-whitespace-1-browser-pre.js
  let local = {};
  let node = whitespace_1_browser_default(local);
