(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/04-whitespace-2-browser.cjs
  var require_whitespace_2_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/04-whitespace-2-browser-pre.cjs
  "use strict";
  var _whitespace2Browser = _interopRequireDefault2(require_whitespace_2_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _whitespace2Browser.default)(local);
