(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/miscellaneous/00-id.cjs
  ...
  // distributable-commonjs/test/library/resource/scenario-00/miscellaneous/00-id-pre-bundle.cjs
  "use strict";
  var _id = _interopRequireDefault2(require_id());
