(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/attribute/06-attribute-interpolation-template.js
  ...
  function attribute_interpolation_template_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/attribute/06-attribute-interpolation-template-pre-bundle.js
  let div = document.querySelector("body div");
  let node = attribute_interpolation_template_default({});
