(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/05-attribute-interpolation.cjs
  var require_attribute_interpolation = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/05-attribute-interpolation-pre-bundle.cjs
  "use strict";
  var _attributeInterpolation = _interopRequireDefault2(require_attribute_interpolation());
