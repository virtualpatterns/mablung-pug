(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/attribute/15-id-literal-div.js
  ...
  function id_literal_div_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/attribute/15-id-literal-div-pre-bundle.js
  let div = document.querySelector("body div");
  let node = id_literal_div_default({});
