(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/conditional/00-default-browser.cjs
  ...
  // distributable-commonjs/test/library/resource/scenario-00/conditional/00-default-browser-pre.cjs
  "use strict";
