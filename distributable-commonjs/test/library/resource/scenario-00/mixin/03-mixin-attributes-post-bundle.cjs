(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/03-mixin-attributes.cjs
  var require_mixin_attributes = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/03-mixin-attributes-pre-bundle.cjs
  "use strict";
  var _mixinAttributes = _interopRequireDefault2(require_mixin_attributes());
