(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/filter/01-inline-syntax-browser.js
  ...
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("p", {}, (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.convertToNode("<strong>BOLD TEXT</strong>"), __node2);
        return __node2;
      })()), __node);
      __utility2.addNode(__utility2.createNode("p", {}, (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.convertToNode("In the midst of a large amount of plain"), __node2);
        __utility2.addNode("\n", __node2);
        __utility2.addNode(__utility2.convertToNode("text, suddenly a wild "), __node2);
        __utility2.addNode(__utility2.convertToNode("<em>Markdown</em>"), __node2);
        __utility2.addNode("", __node2);
        __utility2.addNode("\n", __node2);
        __utility2.addNode(__utility2.convertToNode("appeared."), __node2);
        return __node2;
      })()), __node);
  ...
  function inline_syntax_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/filter/01-inline-syntax-browser-pre.js
  let local = {};
  let node = inline_syntax_browser_default(local);
