(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/06-whitespace-not-recommended.cjs
  var require_whitespace_not_recommended = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/06-whitespace-not-recommended-pre-bundle.cjs
  "use strict";
  var _whitespaceNotRecommended = _interopRequireDefault2(require_whitespace_not_recommended());
