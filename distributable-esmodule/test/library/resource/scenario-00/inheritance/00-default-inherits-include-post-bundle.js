(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/inheritance/00-default-inherits-include.js
  ...
  function default_inherits_include_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/inheritance/00-default-inherits-include-pre-bundle.js
  let div = document.querySelector("body div");
  let node = default_inherits_include_default({});
