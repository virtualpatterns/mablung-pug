(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/code/03-buffered-inline-code.js
  ...
  function buffered_inline_code_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/code/03-buffered-inline-code-pre-bundle.js
  let div = document.querySelector("body div");
  let node = buffered_inline_code_default({});
