(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/include/00-default-head.cjs
  var require_default_head = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/include/00-default-head-pre-bundle.cjs
  "use strict";
  var _defaultHead = _interopRequireDefault2(require_default_head());
