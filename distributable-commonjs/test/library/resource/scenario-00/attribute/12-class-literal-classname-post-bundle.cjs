(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/12-class-literal-classname.cjs
  var require_class_literal_classname = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/12-class-literal-classname-pre-bundle.cjs
  "use strict";
  var _classLiteralClassname = _interopRequireDefault2(require_class_literal_classname());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let div = document.querySelector("body div");
  let node = (0, _classLiteralClassname.default)({});
