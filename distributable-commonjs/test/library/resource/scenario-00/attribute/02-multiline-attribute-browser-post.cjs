(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/02-multiline-attribute-browser.cjs
  var require_multiline_attribute_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/02-multiline-attribute-browser-pre.cjs
  "use strict";
  var _multilineAttributeBrowser = _interopRequireDefault2(require_multiline_attribute_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _multilineAttributeBrowser.default)(local);
