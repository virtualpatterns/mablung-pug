(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/miscellaneous/01-class.js
  ...
  function class_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/miscellaneous/01-class-pre-bundle.js
  let div = document.querySelector("body div");
  let node = class_default({});
