(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/05-tag-interpolation-browser.cjs
  var require_tag_interpolation_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/05-tag-interpolation-browser-pre.cjs
  "use strict";
  var _tagInterpolationBrowser = _interopRequireDefault2(require_tag_interpolation_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _tagInterpolationBrowser.default)(local);
