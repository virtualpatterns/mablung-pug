(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/01-unescaped-string-interpolation-expression.cjs
  var require_unescaped_string_interpolation_expression = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/01-unescaped-string-interpolation-expression-pre-bundle.cjs
  "use strict";
  var _unescapedStringInterpolationExpression = _interopRequireDefault2(require_unescaped_string_interpolation_expression());
