(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/miscellaneous/03-data-href.cjs
  var require_data_href = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/miscellaneous/03-data-href-pre-bundle.cjs
  "use strict";
  var _dataHref = _interopRequireDefault2(require_data_href());
