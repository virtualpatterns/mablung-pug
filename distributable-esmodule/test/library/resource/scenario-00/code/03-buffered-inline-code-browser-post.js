(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/code/03-buffered-inline-code-browser.js
  ...
  function buffered_inline_code_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/code/03-buffered-inline-code-browser-pre.js
  let local = {};
  let node = buffered_inline_code_browser_default(local);
