(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/conditional/01-default-else-if.js
  ...
  function default_else_if_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/conditional/01-default-else-if-pre-bundle.js
  let div = document.querySelector("body div");
  let node = default_else_if_default({});
