(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/iteration/00-each-browser.js
  ...
  function each_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/iteration/00-each-browser-pre.js
  let local = {};
  let node = each_browser_default(local);
