(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/interpolation/00-unescaped-string-interpolation.js
  ...
  function unescaped_string_interpolation_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/interpolation/00-unescaped-string-interpolation-pre-bundle.js
  let div = document.querySelector("body div");
  let node = unescaped_string_interpolation_default({});
