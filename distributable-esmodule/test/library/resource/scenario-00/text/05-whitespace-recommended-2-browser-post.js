(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/text/05-whitespace-recommended-2-browser.js
  ...
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("p", {}, (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.convertToNode("Using regular tags can help keep your lines short,"), __node2);
        __utility2.addNode("\n", __node2);
        __utility2.addNode(__utility2.convertToNode("but interpolated tags may be easier to "), __node2);
        __utility2.addNode(__utility2.createNode("em", {}, (() => {
          const __node3 = [];
          __utility2.addNode(__utility2.convertToNode("visualize"), __node3);
          return __node3;
        })()), __node2);
        __utility2.addNode("", __node2);
        __utility2.addNode("\n", __node2);
        __utility2.addNode(__utility2.convertToNode("whether the tags and text are whitespace-separated."), __node2);
        return __node2;
      })()), __node);
  ...
  function whitespace_recommended_2_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/text/05-whitespace-recommended-2-browser-pre.js
  let local = {};
  let node = whitespace_recommended_2_browser_default(local);
