(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-01/attribute/18-innerText.js
  ...
  function innerText_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-01/attribute/18-innerText-pre-bundle.js
  let div = document.querySelector("body div");
  let node = innerText_default({});
