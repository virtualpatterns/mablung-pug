(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/01-additional-block-browser.cjs
  var require_additional_block_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/01-additional-block-browser-pre.cjs
  "use strict";
  var _additionalBlockBrowser = _interopRequireDefault2(require_additional_block_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _additionalBlockBrowser.default)(local);
