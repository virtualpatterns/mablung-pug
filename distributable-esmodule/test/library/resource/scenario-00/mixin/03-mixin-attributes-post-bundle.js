(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/mixin/03-mixin-attributes.js
  ...
  function mixin_attributes_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/mixin/03-mixin-attributes-pre-bundle.js
  let div = document.querySelector("body div");
  let node = mixin_attributes_default({});
