(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/mixin/00-default-browser.js
  ...
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      ...
      function __mixin__list(attribute, block) {
        ...
        __utility2.addNode(__utility2.createNode("ul", {}, (() => {
          ...
          __utility2.addNode(__utility2.createNode("li", {}, (() => {
            const __node4 = [];
            __utility2.addNode(__utility2.convertToNode("foo"), __node4);
            return __node4;
          })()), __node3);
          __utility2.addNode(__utility2.createNode("li", {}, (() => {
            const __node4 = [];
            __utility2.addNode(__utility2.convertToNode("bar"), __node4);
            return __node4;
          })()), __node3);
          __utility2.addNode(__utility2.createNode("li", {}, (() => {
            const __node4 = [];
            __utility2.addNode(__utility2.convertToNode("baz"), __node4);
            return __node4;
          })()), __node3);
          return __node3;
        })()), __node2);
      ...
      __utility2.addNode(__utility2.createNode("div", {}, (() => {
        const __node2 = [];
        __utility2.addNode(__mixin__list(void 0, void 0), __node2);
        __utility2.addNode(__mixin__list(void 0, void 0), __node2);
        return __node2;
      })()), __node);
  ...
  // distributable-esmodule/test/library/resource/scenario-00/mixin/00-default-browser-pre.js
  let local = {};
