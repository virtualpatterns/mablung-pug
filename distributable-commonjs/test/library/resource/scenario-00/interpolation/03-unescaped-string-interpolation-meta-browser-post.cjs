(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/03-unescaped-string-interpolation-meta-browser.cjs
  var require_unescaped_string_interpolation_meta_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/03-unescaped-string-interpolation-meta-browser-pre.cjs
  "use strict";
  var _unescapedStringInterpolationMetaBrowser = _interopRequireDefault2(require_unescaped_string_interpolation_meta_browser());
