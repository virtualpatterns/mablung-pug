(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/04-whitespace-1.cjs
  var require_whitespace_1 = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/04-whitespace-1-pre-bundle.cjs
  "use strict";
  var _whitespace = _interopRequireDefault2(require_whitespace_1());
