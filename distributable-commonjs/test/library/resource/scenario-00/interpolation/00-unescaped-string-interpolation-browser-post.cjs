(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/00-unescaped-string-interpolation-browser.cjs
  var require_unescaped_string_interpolation_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/00-unescaped-string-interpolation-browser-pre.cjs
  "use strict";
  var _unescapedStringInterpolationBrowser = _interopRequireDefault2(require_unescaped_string_interpolation_browser());
