(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/interpolation/06-whitespace-control.js
  ...
  function whitespace_control_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/interpolation/06-whitespace-control-pre-bundle.js
  let div = document.querySelector("body div");
  let node = whitespace_control_default({});
