(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/code/01-block-unbuffered-code.js
  ...
  function block_unbuffered_code_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/code/01-block-unbuffered-code-pre-bundle.js
  let div = document.querySelector("body div");
  let node = block_unbuffered_code_default({});
