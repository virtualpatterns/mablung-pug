(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/comment/03-block-unbuffered-comment-browser.js
  ...
  function block_unbuffered_comment_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/comment/03-block-unbuffered-comment-browser-pre.js
  let local = {};
  let node = block_unbuffered_comment_browser_default(local);
