(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/iteration/05-while.js
  ...
  function while_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/iteration/05-while-pre-bundle.js
  let div = document.querySelector("body div");
  let node = while_default({});
