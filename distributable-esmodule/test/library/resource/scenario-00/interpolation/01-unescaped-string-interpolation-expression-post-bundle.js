(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/interpolation/01-unescaped-string-interpolation-expression.js
  ...
  function unescaped_string_interpolation_expression_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/interpolation/01-unescaped-string-interpolation-expression-pre-bundle.js
  let div = document.querySelector("body div");
  let node = unescaped_string_interpolation_expression_default({});
