(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/06-attribute-interpolation-template-browser.cjs
  var require_attribute_interpolation_template_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/06-attribute-interpolation-template-browser-pre.cjs
  "use strict";
  var _attributeInterpolationTemplateBrowser = _interopRequireDefault2(require_attribute_interpolation_template_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _attributeInterpolationTemplateBrowser.default)(local);
