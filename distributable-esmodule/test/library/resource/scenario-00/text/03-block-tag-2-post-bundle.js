(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/text/03-block-tag-2.js
  ...
  function block_tag_2_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/text/03-block-tag-2-pre-bundle.js
  let div = document.querySelector("body div");
  let node = block_tag_2_default({});
