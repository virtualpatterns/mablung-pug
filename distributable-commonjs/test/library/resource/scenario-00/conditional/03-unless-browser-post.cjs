(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/conditional/03-unless-browser.cjs
  var require_unless_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/conditional/03-unless-browser-pre.cjs
  "use strict";
  var _unlessBrowser = _interopRequireDefault2(require_unless_browser());
