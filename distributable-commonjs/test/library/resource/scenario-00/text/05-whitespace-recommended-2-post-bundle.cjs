(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/05-whitespace-recommended-2.cjs
  var require_whitespace_recommended_2 = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/05-whitespace-recommended-2-pre-bundle.cjs
  "use strict";
  var _whitespaceRecommended = _interopRequireDefault2(require_whitespace_recommended_2());
