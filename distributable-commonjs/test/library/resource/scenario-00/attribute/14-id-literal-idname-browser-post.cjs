(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/14-id-literal-idname-browser.cjs
  var require_id_literal_idname_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/14-id-literal-idname-browser-pre.cjs
  "use strict";
  var _idLiteralIdnameBrowser = _interopRequireDefault2(require_id_literal_idname_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _idLiteralIdnameBrowser.default)(local);
