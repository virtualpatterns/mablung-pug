(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/01-additional-block.cjs
  var require_additional_block = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/01-additional-block-pre-bundle.cjs
  "use strict";
  var _additionalBlock = _interopRequireDefault2(require_additional_block());
