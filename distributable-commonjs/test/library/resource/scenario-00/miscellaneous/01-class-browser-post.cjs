(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/miscellaneous/01-class-browser.cjs
  var require_class_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/miscellaneous/01-class-browser-pre.cjs
  "use strict";
  var _classBrowser = _interopRequireDefault2(require_class_browser());
