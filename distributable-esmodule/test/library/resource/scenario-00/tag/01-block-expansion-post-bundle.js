(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/tag/01-block-expansion.js
  ...
  function block_expansion_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/tag/01-block-expansion-pre-bundle.js
  let div = document.querySelector("body div");
  let node = block_expansion_default({});
