(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-01/attribute/18-innerText.cjs
  var require_innerText = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-01/attribute/18-innerText-pre-bundle.cjs
  "use strict";
  var _innerText = _interopRequireDefault2(require_innerText());
