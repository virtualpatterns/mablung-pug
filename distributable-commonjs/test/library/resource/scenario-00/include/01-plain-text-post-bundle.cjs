(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/include/01-plain-text.cjs
  var require_plain_text = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/include/01-plain-text-pre-bundle.cjs
  "use strict";
  var _plainText = _interopRequireDefault2(require_plain_text());
