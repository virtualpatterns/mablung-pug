(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/iteration/02-each-keys.js
  ...
  function each_keys_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/iteration/02-each-keys-pre-bundle.js
  let div = document.querySelector("body div");
  let node = each_keys_default({});
