(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/mixin/03-mixin-attributes-browser.js
    ...
    function __getNode2(__utility2 = {}) {
      ...
      function __mixin__link(attribute, block, href, name) {
        ...
        __utility2.addNode(__utility2.createNode("a", (() => {
          const __attribute = {};
          __utility2.addAttribute("class", attributes.class, __attribute);
          return __attribute;
        })(), (() => {
          const __node3 = [];
          {
  ...
  function mixin_attributes_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/mixin/03-mixin-attributes-browser-pre.js
  let local = {};
  let node = mixin_attributes_browser_default(local);
