(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/02-block-append-prepend-inherits.cjs
  var require_block_append_prepend_inherits = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/02-block-append-prepend-inherits-pre-bundle.cjs
  "use strict";
  var _blockAppendPrependInherits = _interopRequireDefault2(require_block_append_prepend_inherits());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let div = document.querySelector("body div");
  let node = (0, _blockAppendPrependInherits.default)({});
