(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/04-mixin-attributes-and-browser.cjs
  var require_mixin_attributes_and_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/04-mixin-attributes-and-browser-pre.cjs
  "use strict";
  var _mixinAttributesAndBrowser = _interopRequireDefault2(require_mixin_attributes_and_browser());
