(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/text/06-whitespace-not-recommended-browser.js
  const utility = __toModule(require_utility());
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      const __node = [];
      __utility2.addNode(__utility2.convertToNode("Hey, check out "), __node);
      __utility2.addNode(__utility2.createNode("a", (() => {
        const __attribute = {};
        __utility2.addAttribute("href", "http://example.biz/kitteh.png", __attribute);
        return __attribute;
      })(), (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.convertToNode("this picture"), __node2);
        return __node2;
      })()), __node);
      __utility2.addNode(__utility2.convertToNode(" of my cat!"), __node);
      return __utility2.getNode(__node);
    }
    return __getNode2(__utility);
  }
  function whitespace_not_recommended_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/text/06-whitespace-not-recommended-browser-pre.js
  let local = {};
  let node = whitespace_not_recommended_browser_default(local);
