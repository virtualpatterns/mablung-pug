(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/inheritance/02-block-append-prepend-inherits-optional.js
  ...
  function block_append_prepend_inherits_optional_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/inheritance/02-block-append-prepend-inherits-optional-pre-bundle.js
  let div = document.querySelector("body div");
  let node = block_append_prepend_inherits_optional_default({});
