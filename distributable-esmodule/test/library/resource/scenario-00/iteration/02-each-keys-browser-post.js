(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/iteration/02-each-keys-browser.js
  ...
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("ul", {}, (() => {
        const __node2 = [];
        __utility2.forEach({1: "one", 2: "two", 3: "three"}, (val, index) => {
  ...
  function each_keys_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/iteration/02-each-keys-browser-pre.js
  let local = {};
  let node = each_keys_browser_default(local);
