(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/case/01-case-fall-through-browser.js
  ...
  function case_fall_through_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/case/01-case-fall-through-browser-pre.js
  let local = {};
  let node = case_fall_through_browser_default(local);
