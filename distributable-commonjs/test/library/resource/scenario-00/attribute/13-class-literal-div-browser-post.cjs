(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/13-class-literal-div-browser.cjs
  var require_class_literal_div_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/13-class-literal-div-browser-pre.cjs
  "use strict";
  var _classLiteralDivBrowser = _interopRequireDefault2(require_class_literal_div_browser());
