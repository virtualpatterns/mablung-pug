(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/miscellaneous/04-colspan-browser.js
  const utility = __toModule(require_utility());
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      const __node = [];
      __utility2.addNode(__utility2.createNode("td", (() => {
        const __attribute = {};
        __utility2.addAttribute("colspan", 3, __attribute);
        return __attribute;
      })(), []), __node);
  ...
  function colspan_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/miscellaneous/04-colspan-browser-pre.js
  let local = {};
  let node = colspan_browser_default(local);
