(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/conditional/02-default-else-browser.cjs
  var require_default_else_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/conditional/02-default-else-browser-pre.cjs
  "use strict";
  var _defaultElseBrowser = _interopRequireDefault2(require_default_else_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _defaultElseBrowser.default)(local);
