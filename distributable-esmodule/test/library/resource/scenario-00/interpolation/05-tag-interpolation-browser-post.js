(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/interpolation/05-tag-interpolation-browser.js
  ...
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("p", {}, (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.convertToNode("This is a very long and boring paragraph that spans multiple lines."), __node2);
        __utility2.addNode("\n", __node2);
        __utility2.addNode(__utility2.convertToNode("Suddenly there is a ![strong strongly worded phrase] that cannot be"), __node2);
        __utility2.addNode("\n", __node2);
        __utility2.addNode(__utility2.convertToNode("![em ignored]."), __node2);
        return __node2;
      })()), __node);
      __utility2.addNode(__utility2.createNode("p", {}, (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.convertToNode("And here's an example of an interpolated tag with an attribute:"), __node2);
        __utility2.addNode("\n", __node2);
        __utility2.addNode(__utility2.convertToNode('![q(lang="es") \xA1Hola Mundo!]'), __node2);
        return __node2;
      })()), __node);
  ...
  function tag_interpolation_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/interpolation/05-tag-interpolation-browser-pre.js
  let local = {};
  let node = tag_interpolation_browser_default(local);
