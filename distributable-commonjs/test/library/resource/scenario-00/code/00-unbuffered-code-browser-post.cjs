(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/code/00-unbuffered-code-browser.cjs
  var require_unbuffered_code_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/code/00-unbuffered-code-browser-pre.cjs
  "use strict";
  var _unbufferedCodeBrowser = _interopRequireDefault2(require_unbuffered_code_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _unbufferedCodeBrowser.default)(local);
