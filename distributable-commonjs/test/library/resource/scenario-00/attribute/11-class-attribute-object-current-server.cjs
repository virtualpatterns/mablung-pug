...
// Path = 'distributable-commonjs/test/library/resource/scenario-00/attribute/11-class-attribute-object-current.pug'
function __getNode(__local = {}, __utility = {}) {
  function __getNode(__utility = {}) {
    ...
    __utility.addNode('', __node) // a(class!={active: currentUrl === '/about'} href!='/about') About
