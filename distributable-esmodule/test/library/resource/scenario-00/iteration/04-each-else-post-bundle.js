(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/iteration/04-each-else.js
  ...
  function each_else_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/iteration/04-each-else-pre-bundle.js
  let div = document.querySelector("body div");
  let node = each_else_default({});
