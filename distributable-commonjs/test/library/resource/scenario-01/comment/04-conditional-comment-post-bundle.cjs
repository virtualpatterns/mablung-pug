(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-01/comment/04-conditional-comment.cjs
  var require_conditional_comment = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-01/comment/04-conditional-comment-pre-bundle.cjs
  "use strict";
  var _conditionalComment = _interopRequireDefault2(require_conditional_comment());
