(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/01-default-arguments.cjs
  var require_default_arguments = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/01-default-arguments-pre-bundle.cjs
  "use strict";
  var _defaultArguments = _interopRequireDefault2(require_default_arguments());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let div = document.querySelector("body div");
  let node = (0, _defaultArguments.default)({});
