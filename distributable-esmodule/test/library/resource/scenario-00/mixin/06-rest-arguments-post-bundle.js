(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/mixin/06-rest-arguments.js
  ...
  function rest_arguments_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/mixin/06-rest-arguments-pre-bundle.js
  let div = document.querySelector("body div");
  let node = rest_arguments_default({});
