(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/00-default-inherits-include.cjs
  var require_default_inherits_include = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/00-default-inherits-include-pre-bundle.cjs
  "use strict";
  var _defaultInheritsInclude = _interopRequireDefault2(require_default_inherits_include());
