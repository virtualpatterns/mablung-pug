(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/04-mixin-attributes-and.cjs
  var require_mixin_attributes_and = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/04-mixin-attributes-and-pre-bundle.cjs
  "use strict";
  var _mixinAttributesAnd = _interopRequireDefault2(require_mixin_attributes_and());
