(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/comment/03-block-unbuffered-comment-browser.cjs
  var require_block_unbuffered_comment_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/comment/03-block-unbuffered-comment-browser-pre.cjs
  "use strict";
  var _blockUnbufferedCommentBrowser = _interopRequireDefault2(require_block_unbuffered_comment_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _blockUnbufferedCommentBrowser.default)(local);
