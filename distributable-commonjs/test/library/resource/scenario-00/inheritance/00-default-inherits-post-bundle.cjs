(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/00-default-inherits.cjs
  var require_default_inherits = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/00-default-inherits-pre-bundle.cjs
  "use strict";
  var _defaultInherits = _interopRequireDefault2(require_default_inherits());
