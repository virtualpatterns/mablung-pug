(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/05-while.cjs
  var require_while = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/05-while-pre-bundle.cjs
  "use strict";
  var _while = _interopRequireDefault2(require_while());
