(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/include/00-default.js
  ...
  function default_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/include/00-default-pre-bundle.js
  let div = document.querySelector("body div");
  let node = default_default({});
