(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/02-multiline-attribute.cjs
  var require_multiline_attribute = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/02-multiline-attribute-pre-bundle.cjs
  "use strict";
  var _multilineAttribute = _interopRequireDefault2(require_multiline_attribute());
