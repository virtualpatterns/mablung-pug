(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/code/03-buffered-inline-code.cjs
  var require_buffered_inline_code = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/code/03-buffered-inline-code-pre-bundle.cjs
  "use strict";
  var _bufferedInlineCode = _interopRequireDefault2(require_buffered_inline_code());
