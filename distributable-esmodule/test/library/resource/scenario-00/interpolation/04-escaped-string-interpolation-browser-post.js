(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/interpolation/04-escaped-string-interpolation-browser.js
  ...
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("div", (() => {
        const __attribute = {};
        __utility2.addAttribute("class", "quote", __attribute);
        return __attribute;
      })(), (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.createNode("p", {}, (() => {
          const __node3 = [];
          __utility2.addNode(__utility2.convertToNode("Joel: "), __node3);
          {
  ...
  function escaped_string_interpolation_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/interpolation/04-escaped-string-interpolation-browser-pre.js
  let local = {};
  let node = escaped_string_interpolation_browser_default(local);
