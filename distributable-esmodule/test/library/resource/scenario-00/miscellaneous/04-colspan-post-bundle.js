(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/miscellaneous/04-colspan.js
  ...
  function colspan_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/miscellaneous/04-colspan-pre-bundle.js
  let div = document.querySelector("body div");
  let node = colspan_default({});
