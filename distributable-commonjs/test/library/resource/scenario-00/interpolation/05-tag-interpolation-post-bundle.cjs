(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/05-tag-interpolation.cjs
  var require_tag_interpolation = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/05-tag-interpolation-pre-bundle.cjs
  "use strict";
  var _tagInterpolation = _interopRequireDefault2(require_tag_interpolation());
