(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/01-additional-block-inherits-browser.cjs
  var require_additional_block_inherits_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/01-additional-block-inherits-browser-pre.cjs
  "use strict";
  var _additionalBlockInheritsBrowser = _interopRequireDefault2(require_additional_block_inherits_browser());
