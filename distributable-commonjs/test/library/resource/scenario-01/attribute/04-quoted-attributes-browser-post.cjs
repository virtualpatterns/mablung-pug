(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-01/attribute/04-quoted-attributes-browser.cjs
  var require_quoted_attributes_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-01/attribute/04-quoted-attributes-browser-pre.cjs
  "use strict";
  var _quotedAttributesBrowser = _interopRequireDefault2(require_quoted_attributes_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _quotedAttributesBrowser.default)(local);
