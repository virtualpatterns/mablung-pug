(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/include/01-plain-text-browser.js
    ...
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("html", {}, (() => {
        ...
        __utility2.addNode(__utility2.createNode("head", {}, (() => {
          const __node3 = [];
          __utility2.addNode(__utility2.createNode("style", {}, (() => {
            const __node4 = [];
            __utility2.addNode(__utility2.convertToNode("h1 {\n  color: red;\n}"), __node4);
            return __node4;
          })()), __node3);
          return __node3;
        })()), __node2);
        __utility2.addNode(__utility2.createNode("body", {}, (() => {
          ...
          __utility2.addNode(__utility2.createNode("script", {}, (() => {
            const __node4 = [];
            __utility2.addNode(__utility2.convertToNode("console.log('You are awesome')"), __node4);
            return __node4;
          })()), __node3);
          return __node3;
        })()), __node2);
  ...
  function plain_text_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/include/01-plain-text-browser-pre.js
  let local = {};
  let node = plain_text_browser_default(local);
