(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/conditional/01-default-else-if-browser.js
  ...
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("div", (() => {
        const __attribute = {};
        __utility2.addAttribute("id", "user", __attribute);
        return __attribute;
      })(), (() => {
        const __node2 = [];
        if (user.description) {
          __utility2.addNode(__utility2.createNode("h2", (() => {
            const __attribute = {};
            __utility2.addAttribute("class", "green", __attribute);
            return __attribute;
          })(), (() => {
            const __node3 = [];
            __utility2.addNode(__utility2.convertToNode("Description"), __node3);
            return __node3;
          })()), __node2);
          __utility2.addNode(__utility2.createNode("p", (() => {
            const __attribute = {};
            __utility2.addAttribute("class", "description", __attribute);
            return __attribute;
          })(), (() => {
            const __node3 = [];
            {
              ...
              if (typeof value === "string") {
                __utility2.addNode(__utility2.convertToNode(value), __node3);
              } else {
                __utility2.addNode(value, __node3);
              }
            }
            return __node3;
          })()), __node2);
          ...
          if (authorised) {
            __utility2.addNode(__utility2.createNode("h2", (() => {
              const __attribute = {};
              __utility2.addAttribute("class", "blue", __attribute);
              return __attribute;
            })(), (() => {
              const __node3 = [];
              __utility2.addNode(__utility2.convertToNode("Description"), __node3);
            ...
            __utility2.addNode(__utility2.createNode("p", (() => {
              ...
              const __node3 = [];
              __utility2.addNode(__utility2.convertToNode("User has no description,"), __node3);
              __utility2.addNode("\n", __node3);
              __utility2.addNode(__utility2.convertToNode("why not add one..."), __node3);
              return __node3;
            })()), __node2);
          } else {
            __utility2.addNode(__utility2.createNode("h2", (() => {
              const __attribute = {};
              __utility2.addAttribute("class", "red", __attribute);
              return __attribute;
            })(), (() => {
              const __node3 = [];
              __utility2.addNode(__utility2.convertToNode("Description"), __node3);
  ...
  function default_else_if_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/conditional/01-default-else-if-browser-pre.js
  let local = {};
  let node = default_else_if_browser_default(local);
