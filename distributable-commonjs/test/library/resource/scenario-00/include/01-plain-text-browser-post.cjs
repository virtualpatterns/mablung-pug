(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/include/01-plain-text-browser.cjs
  var require_plain_text_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/include/01-plain-text-browser-pre.cjs
  "use strict";
  var _plainTextBrowser = _interopRequireDefault2(require_plain_text_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _plainTextBrowser.default)(local);
