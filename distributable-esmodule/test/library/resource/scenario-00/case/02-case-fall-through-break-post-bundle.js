(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/case/02-case-fall-through-break.js
  ...
  function case_fall_through_break_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/case/02-case-fall-through-break-pre-bundle.js
  let div = document.querySelector("body div");
  let node = case_fall_through_break_default({});
