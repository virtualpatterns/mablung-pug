(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/02-mixin-block.cjs
  var require_mixin_block = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/02-mixin-block-pre-bundle.cjs
  "use strict";
  var _mixinBlock = _interopRequireDefault2(require_mixin_block());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let div = document.querySelector("body div");
  let node = (0, _mixinBlock.default)({});
