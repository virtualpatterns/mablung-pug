(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/11-class-attribute-object-current-browser.cjs
  var require_class_attribute_object_current_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/11-class-attribute-object-current-browser-pre.cjs
  "use strict";
  var _classAttributeObjectCurrentBrowser = _interopRequireDefault2(require_class_attribute_object_current_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _classAttributeObjectCurrentBrowser.default)(local);
