(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/02-mixin-block-browser.cjs
  var require_mixin_block_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/02-mixin-block-browser-pre.cjs
  "use strict";
  var _mixinBlockBrowser = _interopRequireDefault2(require_mixin_block_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _mixinBlockBrowser.default)(local);
