(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/02-piped-text-browser.cjs
  var require_piped_text_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/02-piped-text-browser-pre.cjs
  "use strict";
  var _pipedTextBrowser = _interopRequireDefault2(require_piped_text_browser());
