(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/filter/01-inline-syntax-browser.cjs
  var require_inline_syntax_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/filter/01-inline-syntax-browser-pre.cjs
  "use strict";
  var _inlineSyntaxBrowser = _interopRequireDefault2(require_inline_syntax_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _inlineSyntaxBrowser.default)(local);
