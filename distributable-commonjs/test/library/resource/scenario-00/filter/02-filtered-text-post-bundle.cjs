(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/filter/02-filtered-text.cjs
  var require_filtered_text = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/filter/02-filtered-text-pre-bundle.cjs
  "use strict";
  var _filteredText = _interopRequireDefault2(require_filtered_text());
