(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/miscellaneous/00-id-browser.js
  ...
  function id_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/miscellaneous/00-id-browser-pre.js
  let local = {};
  let node = id_browser_default(local);
