(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/05-default-values.cjs
  var require_default_values = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/05-default-values-pre-bundle.cjs
  "use strict";
  var _defaultValues = _interopRequireDefault2(require_default_values());
