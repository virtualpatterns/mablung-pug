(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/case/03-block-expansion-browser.cjs
  ...
  // distributable-commonjs/test/library/resource/scenario-00/case/03-block-expansion-browser-pre.cjs
  "use strict";
