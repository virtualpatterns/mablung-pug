(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/05-default-values-browser.cjs
  var require_default_values_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/05-default-values-browser-pre.cjs
  "use strict";
  var _defaultValuesBrowser = _interopRequireDefault2(require_default_values_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _defaultValuesBrowser.default)(local);
