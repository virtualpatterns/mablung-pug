(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/attribute/17-and-attribute-variable-browser.js
  ...
  function and_attribute_variable_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/attribute/17-and-attribute-variable-browser-pre.js
  let local = {};
  let node = and_attribute_variable_browser_default(local);
