(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/12-class-literal-classname-browser.cjs
  var require_class_literal_classname_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/12-class-literal-classname-browser-pre.cjs
  "use strict";
  var _classLiteralClassnameBrowser = _interopRequireDefault2(require_class_literal_classname_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _classLiteralClassnameBrowser.default)(local);
