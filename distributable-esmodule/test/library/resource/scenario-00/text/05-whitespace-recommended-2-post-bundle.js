(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/text/05-whitespace-recommended-2.js
  ...
  function whitespace_recommended_2_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/text/05-whitespace-recommended-2-pre-bundle.js
  let div = document.querySelector("body div");
  let node = whitespace_recommended_2_default({});
