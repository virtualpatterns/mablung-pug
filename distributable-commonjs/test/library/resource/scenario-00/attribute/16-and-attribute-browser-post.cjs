(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/16-and-attribute-browser.cjs
  var require_and_attribute_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/16-and-attribute-browser-pre.cjs
  "use strict";
  var _andAttributeBrowser = _interopRequireDefault2(require_and_attribute_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _andAttributeBrowser.default)(local);
