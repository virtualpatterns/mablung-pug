(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-01/comment/04-conditional-comment-browser.js
  const utility = __toModule(require_utility());
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      const __node = [];
      __utility2.addNode(__utility2.convertToNode('<!--[if IE 8]>\n<html lang="en" class="lt-ie9">\n<![endif]-->\n<!--[if gt IE 8]><!-->\n<html lang="en">\n<!--<![endif]-->'), __node);
      __utility2.addNode(__utility2.createNode("body", {}, (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.createNode("p", {}, (() => {
          const __node3 = [];
          __utility2.addNode(__utility2.convertToNode("Supporting old web browsers is a pain."), __node3);
          return __node3;
        })()), __node2);
        return __node2;
      })()), __node);
  ...
  function conditional_comment_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-01/comment/04-conditional-comment-browser-pre.js
  let local = {};
  let node = conditional_comment_browser_default(local);
