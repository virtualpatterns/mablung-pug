(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/04-each-else.cjs
  var require_each_else = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/04-each-else-pre-bundle.cjs
  "use strict";
  var _eachElse = _interopRequireDefault2(require_each_else());
