(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/text/05-whitespace-recommended-1-browser.js
  const utility = __toModule(require_utility());
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      const __node = [];
      __utility2.addNode(__utility2.convertToNode("Don't"), __node);
      __utility2.addNode("\n", __node);
      __utility2.addNode("", __node);
      __utility2.addNode(__utility2.createNode("button", (() => {
        const __attribute = {};
        __utility2.addAttribute("id", "self-destruct", __attribute);
        return __attribute;
      })(), (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.convertToNode("touch"), __node2);
        return __node2;
      })()), __node);
      __utility2.addNode("", __node);
      __utility2.addNode("\n", __node);
      __utility2.addNode(__utility2.convertToNode("me!"), __node);
      return __utility2.getNode(__node);
    }
    return __getNode2(__utility);
  }
  function whitespace_recommended_1_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/text/05-whitespace-recommended-1-browser-pre.js
  let local = {};
  let node = whitespace_recommended_1_browser_default(local);
