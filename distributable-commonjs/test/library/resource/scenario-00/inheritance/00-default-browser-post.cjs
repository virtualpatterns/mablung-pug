(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/00-default-browser.cjs
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/00-default-browser-pre.cjs
  "use strict";
