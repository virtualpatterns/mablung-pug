(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/17-and-attribute-variable-browser.cjs
  var require_and_attribute_variable_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/17-and-attribute-variable-browser-pre.cjs
  "use strict";
  var _andAttributeVariableBrowser = _interopRequireDefault2(require_and_attribute_variable_browser());
