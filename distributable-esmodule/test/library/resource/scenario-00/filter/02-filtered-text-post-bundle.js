(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/filter/02-filtered-text.js
  ...
  function filtered_text_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/filter/02-filtered-text-pre-bundle.js
  let div = document.querySelector("body div");
  let node = filtered_text_default({});
