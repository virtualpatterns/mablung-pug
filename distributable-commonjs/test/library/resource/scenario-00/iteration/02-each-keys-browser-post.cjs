(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/02-each-keys-browser.cjs
  var require_each_keys_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/02-each-keys-browser-pre.cjs
  "use strict";
  var _eachKeysBrowser = _interopRequireDefault2(require_each_keys_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _eachKeysBrowser.default)(local);
