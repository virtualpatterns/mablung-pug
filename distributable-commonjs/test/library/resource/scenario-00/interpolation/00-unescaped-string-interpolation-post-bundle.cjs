(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/00-unescaped-string-interpolation.cjs
  var require_unescaped_string_interpolation = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/00-unescaped-string-interpolation-pre-bundle.cjs
  "use strict";
  var _unescapedStringInterpolation = _interopRequireDefault2(require_unescaped_string_interpolation());
