(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/attribute/11-class-attribute-object-current.js
  ...
  function class_attribute_object_current_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/attribute/11-class-attribute-object-current-pre-bundle.js
  let div = document.querySelector("body div");
  let node = class_attribute_object_current_default({});
