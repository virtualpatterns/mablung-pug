(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/04-escaped-string-interpolation.cjs
  var require_escaped_string_interpolation = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/04-escaped-string-interpolation-pre-bundle.cjs
  "use strict";
  var _escapedStringInterpolation = _interopRequireDefault2(require_escaped_string_interpolation());
