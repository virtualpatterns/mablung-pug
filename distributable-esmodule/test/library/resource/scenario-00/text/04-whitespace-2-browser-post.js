(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/text/04-whitespace-2-browser.js
  ...
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("a", {}, (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.convertToNode("...sentence ending with a link"), __node2);
        return __node2;
      })()), __node);
      __utility2.addNode(__utility2.convertToNode("."), __node);
      return __utility2.getNode(__node);
    }
    return __getNode2(__utility);
  }
  function whitespace_2_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/text/04-whitespace-2-browser-pre.js
  let local = {};
  let node = whitespace_2_browser_default(local);
