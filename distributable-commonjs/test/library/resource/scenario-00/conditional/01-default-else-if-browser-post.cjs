(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/conditional/01-default-else-if-browser.cjs
  var require_default_else_if_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/conditional/01-default-else-if-browser-pre.cjs
  "use strict";
  var _defaultElseIfBrowser = _interopRequireDefault2(require_default_else_if_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _defaultElseIfBrowser.default)(local);
