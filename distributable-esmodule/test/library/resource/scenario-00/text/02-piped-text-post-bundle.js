(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/text/02-piped-text.js
  ...
  function piped_text_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/text/02-piped-text-pre-bundle.js
  let div = document.querySelector("body div");
  let node = piped_text_default({});
