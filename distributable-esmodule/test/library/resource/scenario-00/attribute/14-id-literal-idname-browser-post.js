(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/attribute/14-id-literal-idname-browser.js
  ...
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("a", (() => {
        const __attribute = {};
        __utility2.addAttribute("id", "main-link", __attribute);
        return __attribute;
      })(), []), __node);
  ...
  function id_literal_idname_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/attribute/14-id-literal-idname-browser-pre.js
  let local = {};
  let node = id_literal_idname_browser_default(local);
