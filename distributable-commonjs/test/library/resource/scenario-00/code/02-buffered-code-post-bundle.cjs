(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/code/02-buffered-code.cjs
  var require_buffered_code = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/code/02-buffered-code-pre-bundle.cjs
  "use strict";
  var _bufferedCode = _interopRequireDefault2(require_buffered_code());
