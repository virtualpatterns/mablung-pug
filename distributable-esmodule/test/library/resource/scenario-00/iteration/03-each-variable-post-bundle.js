(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/iteration/03-each-variable.js
  ...
  function each_variable_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/iteration/03-each-variable-pre-bundle.js
  let div = document.querySelector("body div");
  let node = each_variable_default({});
