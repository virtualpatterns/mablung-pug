(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/05-whitespace-recommended-1.cjs
  var require_whitespace_recommended_1 = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/05-whitespace-recommended-1-pre-bundle.cjs
  "use strict";
  var _whitespaceRecommended = _interopRequireDefault2(require_whitespace_recommended_1());
