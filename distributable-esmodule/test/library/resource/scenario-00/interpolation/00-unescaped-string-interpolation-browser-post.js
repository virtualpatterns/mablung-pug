(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/interpolation/00-unescaped-string-interpolation-browser.js
  ...
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("p", {}, (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.convertToNode("Written with love by "), __node2);
        {
          let value = author;
          if (typeof value === "string") {
            __utility2.addNode(__utility2.convertToNode(value), __node2);
      ...
      __utility2.addNode(__utility2.createNode("p", {}, (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.convertToNode("This will be safe: "), __node2);
        {
          let value = theGreat;
          if (typeof value === "string") {
            __utility2.addNode(__utility2.convertToNode(value), __node2);
  ...
  function unescaped_string_interpolation_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/interpolation/00-unescaped-string-interpolation-browser-pre.js
  let local = {};
  let node = unescaped_string_interpolation_browser_default(local);
