(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/11-class-attribute-object-current.cjs
  var require_class_attribute_object_current = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/11-class-attribute-object-current-pre-bundle.cjs
  "use strict";
  var _classAttributeObjectCurrent = _interopRequireDefault2(require_class_attribute_object_current());
