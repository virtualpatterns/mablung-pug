(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/miscellaneous/03-data-href.js
  ...
  function data_href_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/miscellaneous/03-data-href-pre-bundle.js
  let div = document.querySelector("body div");
  let node = data_href_default({});
