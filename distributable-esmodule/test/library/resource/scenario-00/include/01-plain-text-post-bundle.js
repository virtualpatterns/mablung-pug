(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/include/01-plain-text.js
  ...
  function plain_text_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/include/01-plain-text-pre-bundle.js
  let div = document.querySelector("body div");
  let node = plain_text_default({});
