(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/code/02-buffered-code.js
  ...
  function buffered_code_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/code/02-buffered-code-pre-bundle.js
  let div = document.querySelector("body div");
  let node = buffered_code_default({});
