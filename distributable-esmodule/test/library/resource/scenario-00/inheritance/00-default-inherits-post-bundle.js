(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/inheritance/00-default-inherits.js
  ...
  function default_inherits_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/inheritance/00-default-inherits-pre-bundle.js
  let div = document.querySelector("body div");
  let node = default_inherits_default({});
