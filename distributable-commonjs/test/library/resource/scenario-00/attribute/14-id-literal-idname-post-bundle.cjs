(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/14-id-literal-idname.cjs
  var require_id_literal_idname = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/14-id-literal-idname-pre-bundle.cjs
  "use strict";
  var _idLiteralIdname = _interopRequireDefault2(require_id_literal_idname());
