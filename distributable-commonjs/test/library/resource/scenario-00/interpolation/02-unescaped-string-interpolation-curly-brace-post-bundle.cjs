(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/02-unescaped-string-interpolation-curly-brace.cjs
  var require_unescaped_string_interpolation_curly_brace = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/02-unescaped-string-interpolation-curly-brace-pre-bundle.cjs
  "use strict";
  var _unescapedStringInterpolationCurlyBrace = _interopRequireDefault2(require_unescaped_string_interpolation_curly_brace());
