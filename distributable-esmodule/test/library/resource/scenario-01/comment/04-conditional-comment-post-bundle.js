(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-01/comment/04-conditional-comment.js
  ...
  function conditional_comment_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-01/comment/04-conditional-comment-pre-bundle.js
  let div = document.querySelector("body div");
  let node = conditional_comment_default({});
