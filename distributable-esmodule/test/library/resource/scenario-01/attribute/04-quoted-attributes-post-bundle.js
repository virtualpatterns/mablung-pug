(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-01/attribute/04-quoted-attributes.js
  ...
  function quoted_attributes_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-01/attribute/04-quoted-attributes-pre-bundle.js
  let div = document.querySelector("body div");
  let node = quoted_attributes_default({});
