(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/miscellaneous/04-colspan-browser.cjs
  var require_colspan_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/miscellaneous/04-colspan-browser-pre.cjs
  "use strict";
  var _colspanBrowser = _interopRequireDefault2(require_colspan_browser());
