(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/attribute/09-style-attribute.js
  ...
  function style_attribute_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/attribute/09-style-attribute-pre-bundle.js
  let div = document.querySelector("body div");
  let node = style_attribute_default({});
