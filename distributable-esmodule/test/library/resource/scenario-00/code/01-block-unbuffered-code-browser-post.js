(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/code/01-block-unbuffered-code-browser.js
  const utility = __toModule(require_utility());
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      const __node = [];
      var list = ["Uno", "Dos", "Tres", "Cuatro", "Cinco", "Seis"];
      __utility2.forEach(list, (item) => {
  ...
  function block_unbuffered_code_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/code/01-block-unbuffered-code-browser-pre.js
  let local = {};
  let node = block_unbuffered_code_browser_default(local);
