(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/01-default-expression-browser.cjs
  var require_default_expression_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/01-default-expression-browser-pre.cjs
  "use strict";
  var _defaultExpressionBrowser = _interopRequireDefault2(require_default_expression_browser());
