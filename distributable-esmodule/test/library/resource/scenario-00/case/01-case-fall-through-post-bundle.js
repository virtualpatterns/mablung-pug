(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/case/01-case-fall-through.js
  ...
  function case_fall_through_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/case/01-case-fall-through-pre-bundle.js
  let div = document.querySelector("body div");
  let node = case_fall_through_default({});
