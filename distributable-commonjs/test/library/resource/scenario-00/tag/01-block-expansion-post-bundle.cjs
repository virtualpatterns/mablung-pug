(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/tag/01-block-expansion.cjs
  var require_block_expansion = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/tag/01-block-expansion-pre-bundle.cjs
  "use strict";
  var _blockExpansion = _interopRequireDefault2(require_block_expansion());
