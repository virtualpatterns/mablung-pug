(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/code/00-unbuffered-code-browser.js
    ...
    function __getNode2(__utility2 = {}) {
      ...
      for (var x = 0; x < 1; x++) {
        __utility2.addNode(__utility2.createNode("li", {}, (() => {
          const __node2 = [];
          __utility2.addNode(__utility2.convertToNode("item"), __node2);
          return __node2;
        })()), __node);
      }
  ...
  function unbuffered_code_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/code/00-unbuffered-code-browser-pre.js
  let local = {};
  let node = unbuffered_code_browser_default(local);
