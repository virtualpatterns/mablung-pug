...
// Path = 'distributable-commonjs/test/library/resource/scenario-00/mixin/01-default-arguments.pug'
    ...
    __utility.addNode(
      __utility.createNode(
        ...
        (() => {
          ...
          __utility.addNode(__mixin__pet(undefined, undefined, 'cat'), __node)

          __utility.addNode(__mixin__pet(undefined, undefined, 'dog'), __node)

          __utility.addNode(__mixin__pet(undefined, undefined, 'pig'), __node)
