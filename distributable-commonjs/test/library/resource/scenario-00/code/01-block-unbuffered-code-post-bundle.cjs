(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/code/01-block-unbuffered-code.cjs
  var require_block_unbuffered_code = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/code/01-block-unbuffered-code-pre-bundle.cjs
  "use strict";
  var _blockUnbufferedCode = _interopRequireDefault2(require_block_unbuffered_code());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let div = document.querySelector("body div");
  let node = (0, _blockUnbufferedCode.default)({});
