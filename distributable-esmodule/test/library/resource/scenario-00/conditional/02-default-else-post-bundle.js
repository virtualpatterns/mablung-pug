(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/conditional/02-default-else.js
  ...
  function default_else_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/conditional/02-default-else-pre-bundle.js
  let div = document.querySelector("body div");
  let node = default_else_default({});
