(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/code/00-unbuffered-code.js
  ...
  function unbuffered_code_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/code/00-unbuffered-code-pre-bundle.js
  let div = document.querySelector("body div");
  let node = unbuffered_code_default({});
