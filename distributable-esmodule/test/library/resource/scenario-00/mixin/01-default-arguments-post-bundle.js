(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/mixin/01-default-arguments.js
  ...
  function default_arguments_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/mixin/01-default-arguments-pre-bundle.js
  let div = document.querySelector("body div");
  let node = default_arguments_default({});
