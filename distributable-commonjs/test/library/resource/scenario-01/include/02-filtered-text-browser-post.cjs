(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-01/include/02-filtered-text-browser.cjs
  var require_filtered_text_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-01/include/02-filtered-text-browser-pre.cjs
  "use strict";
  var _filteredTextBrowser = _interopRequireDefault2(require_filtered_text_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _filteredTextBrowser.default)(local);
