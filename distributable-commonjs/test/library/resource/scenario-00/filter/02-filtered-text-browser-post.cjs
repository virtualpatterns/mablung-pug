(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/filter/02-filtered-text-browser.cjs
  ...
  // distributable-commonjs/test/library/resource/scenario-00/filter/02-filtered-text-browser-pre.cjs
  "use strict";
