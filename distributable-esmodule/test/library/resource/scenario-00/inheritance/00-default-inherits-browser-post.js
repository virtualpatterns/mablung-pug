(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/inheritance/00-default-inherits-browser.js
    ...
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("html", {}, (() => {
        ...
        __utility2.addNode(__utility2.createNode("head", {}, (() => {
          ...
          __utility2.addNode(__utility2.createNode("script", (() => {
            const __attribute = {};
            __utility2.addAttribute("src", "/pets.js", __attribute);
            return __attribute;
          })(), []), __node3);
          return __node3;
        })()), __node2);
        __utility2.addNode(__utility2.createNode("body", {}, (() => {
          const __node3 = [];
          __utility2.addNode(__utility2.createNode("h1", {}, (() => {
            const __node4 = [];
            {
              let value = title;
              if (typeof value === "string") {
          ...
          var pets = ["cat", "dog"];
          __utility2.forEach(pets, (petName) => {
  ...
  function default_inherits_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/inheritance/00-default-inherits-browser-pre.js
  let local = {};
  let node = default_inherits_browser_default(local);
