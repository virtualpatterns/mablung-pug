(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/include/00-default-head.js
  ...
  function default_head_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/include/00-default-head-pre-bundle.js
  let div = document.querySelector("body div");
  let node = default_head_default({});
