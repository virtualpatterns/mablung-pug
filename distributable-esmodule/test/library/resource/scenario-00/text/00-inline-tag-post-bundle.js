(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/text/00-inline-tag.js
  ...
  function inline_tag_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/text/00-inline-tag-pre-bundle.js
  let div = document.querySelector("body div");
  let node = inline_tag_default({});
