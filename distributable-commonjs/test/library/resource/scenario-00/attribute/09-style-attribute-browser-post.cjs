(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/09-style-attribute-browser.cjs
  var require_style_attribute_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/09-style-attribute-browser-pre.cjs
  "use strict";
  var _styleAttributeBrowser = _interopRequireDefault2(require_style_attribute_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _styleAttributeBrowser.default)(local);
