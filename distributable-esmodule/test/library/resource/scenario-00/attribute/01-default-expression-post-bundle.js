(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/attribute/01-default-expression.js
  ...
  function default_expression_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/attribute/01-default-expression-pre-bundle.js
  let div = document.querySelector("body div");
  let node = default_expression_default({});
