(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/attribute/06-attribute-interpolation-template-browser.js
  ...
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("button", (() => {
        const __attribute = {};
        __utility2.addAttribute("class", "btn btn-" + btnType + " btn-" + btnSize, __attribute);
        return __attribute;
      })(), []), __node);
  ...
  function attribute_interpolation_template_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/attribute/06-attribute-interpolation-template-browser-pre.js
  let local = {};
  let node = attribute_interpolation_template_browser_default(local);
