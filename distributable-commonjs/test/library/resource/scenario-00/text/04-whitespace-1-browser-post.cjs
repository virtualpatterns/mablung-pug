(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/04-whitespace-1-browser.cjs
  var require_whitespace_1_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/text/04-whitespace-1-browser-pre.cjs
  "use strict";
  var _whitespace1Browser = _interopRequireDefault2(require_whitespace_1_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _whitespace1Browser.default)(local);
