(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/interpolation/05-tag-interpolation.js
  ...
  function tag_interpolation_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/interpolation/05-tag-interpolation-pre-bundle.js
  let div = document.querySelector("body div");
  let node = tag_interpolation_default({});
