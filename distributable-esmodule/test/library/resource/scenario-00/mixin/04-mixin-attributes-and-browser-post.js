(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/mixin/04-mixin-attributes-and-browser.js
    ...
    function __getNode2(__utility2 = {}) {
      ...
      function __mixin__link(attribute, block, href, name) {
        ...
        __utility2.addNode(__utility2.createNode("a", (() => {
          const __attribute = {};
          __utility2.addAndAttribute(attributes, __attribute);
          return __attribute;
        })(), (() => {
          const __node3 = [];
          {
      ...
      __utility2.addNode(__mixin__link((() => {
        const __attribute = {};
        __utility2.addAttribute("class", "btn", __attribute);
        return __attribute;
      })(), void 0, "/foo", "foo"), __node);
      return __utility2.getNode(__node);
    }
    return __getNode2(__utility);
  }
  function mixin_attributes_and_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/mixin/04-mixin-attributes-and-browser-pre.js
  let local = {};
  let node = mixin_attributes_and_browser_default(local);
