(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/conditional/02-default-else-browser.js
  ...
  function default_else_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/conditional/02-default-else-browser-pre.js
  let local = {};
  let node = default_else_browser_default(local);
