(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/08-boolean-attribute-browser.cjs
  var require_boolean_attribute_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/08-boolean-attribute-browser-pre.cjs
  "use strict";
  var _booleanAttributeBrowser = _interopRequireDefault2(require_boolean_attribute_browser());
