(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/01-each-index-browser.cjs
  var require_each_index_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/01-each-index-browser-pre.cjs
  "use strict";
  var _eachIndexBrowser = _interopRequireDefault2(require_each_index_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _eachIndexBrowser.default)(local);
