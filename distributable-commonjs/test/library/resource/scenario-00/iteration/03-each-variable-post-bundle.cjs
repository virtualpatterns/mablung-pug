(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/03-each-variable.cjs
  var require_each_variable = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/03-each-variable-pre-bundle.cjs
  "use strict";
  var _eachVariable = _interopRequireDefault2(require_each_variable());
