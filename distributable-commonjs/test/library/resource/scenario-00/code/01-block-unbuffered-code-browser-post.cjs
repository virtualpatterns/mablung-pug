(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/code/01-block-unbuffered-code-browser.cjs
  var require_block_unbuffered_code_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/code/01-block-unbuffered-code-browser-pre.cjs
  "use strict";
  var _blockUnbufferedCodeBrowser = _interopRequireDefault2(require_block_unbuffered_code_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _blockUnbufferedCodeBrowser.default)(local);
