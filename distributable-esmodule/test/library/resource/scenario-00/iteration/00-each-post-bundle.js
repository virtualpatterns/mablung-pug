(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/iteration/00-each.js
  ...
  function each_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/iteration/00-each-pre-bundle.js
  let div = document.querySelector("body div");
  let node = each_default({});
