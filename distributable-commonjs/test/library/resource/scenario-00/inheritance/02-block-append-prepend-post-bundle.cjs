(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/02-block-append-prepend.cjs
  var require_block_append_prepend = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/02-block-append-prepend-pre-bundle.cjs
  "use strict";
  var _blockAppendPrepend = _interopRequireDefault2(require_block_append_prepend());
