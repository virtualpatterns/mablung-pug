(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/09-style-attribute.cjs
  var require_style_attribute = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/09-style-attribute-pre-bundle.cjs
  "use strict";
  var _styleAttribute = _interopRequireDefault2(require_style_attribute());
