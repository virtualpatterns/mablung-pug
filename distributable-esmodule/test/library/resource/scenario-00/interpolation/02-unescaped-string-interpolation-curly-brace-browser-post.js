(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/interpolation/02-unescaped-string-interpolation-curly-brace-browser.js
  ...
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("p", {}, (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.convertToNode("No escaping for "), __node2);
        {
          let value = "}";
          if (typeof value === "string") {
        ...
        __utility2.addNode(__utility2.convertToNode("!"), __node2);
        return __node2;
      })()), __node);
  ...
  function unescaped_string_interpolation_curly_brace_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/interpolation/02-unescaped-string-interpolation-curly-brace-browser-pre.js
  let local = {};
  let node = unescaped_string_interpolation_curly_brace_browser_default(local);
