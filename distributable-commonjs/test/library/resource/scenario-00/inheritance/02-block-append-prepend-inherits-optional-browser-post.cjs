(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/02-block-append-prepend-inherits-optional-browser.cjs
  var require_block_append_prepend_inherits_optional_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/02-block-append-prepend-inherits-optional-browser-pre.cjs
  "use strict";
  var _blockAppendPrependInheritsOptionalBrowser = _interopRequireDefault2(require_block_append_prepend_inherits_optional_browser());
