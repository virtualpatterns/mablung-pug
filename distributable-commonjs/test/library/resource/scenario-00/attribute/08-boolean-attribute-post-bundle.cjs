(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/08-boolean-attribute.cjs
  var require_boolean_attribute = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/08-boolean-attribute-pre-bundle.cjs
  "use strict";
  var _booleanAttribute = _interopRequireDefault2(require_boolean_attribute());
