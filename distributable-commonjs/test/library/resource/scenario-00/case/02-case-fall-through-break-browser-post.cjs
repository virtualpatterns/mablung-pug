(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/case/02-case-fall-through-break-browser.cjs
  var require_case_fall_through_break_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/case/02-case-fall-through-break-browser-pre.cjs
  "use strict";
  var _caseFallThroughBreakBrowser = _interopRequireDefault2(require_case_fall_through_break_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _caseFallThroughBreakBrowser.default)(local);
