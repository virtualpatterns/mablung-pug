(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/text/03-block-tag-2-browser.js
    ...
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("div", {}, (() => {
        ...
        __utility2.addNode(__utility2.createNode("p", {}, (() => {
          const __node3 = [];
          __utility2.addNode(__utility2.convertToNode("This text belongs to the paragraph tag."), __node3);
          return __node3;
        })()), __node2);
        __utility2.addNode(__utility2.createNode("br", {}, []), __node2);
        __utility2.addNode(__utility2.convertToNode("This text belongs to the div tag."), __node2);
        return __node2;
      })()), __node);
  ...
  function block_tag_2_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/text/03-block-tag-2-browser-pre.js
  let local = {};
  let node = block_tag_2_browser_default(local);
