(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/case/01-case-fall-through.cjs
  var require_case_fall_through = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/case/01-case-fall-through-pre-bundle.cjs
  "use strict";
  var _caseFallThrough = _interopRequireDefault2(require_case_fall_through());
