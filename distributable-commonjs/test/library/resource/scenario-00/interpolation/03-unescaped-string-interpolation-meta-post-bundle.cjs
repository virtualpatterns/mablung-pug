(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/03-unescaped-string-interpolation-meta.cjs
  var require_unescaped_string_interpolation_meta = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/interpolation/03-unescaped-string-interpolation-meta-pre-bundle.cjs
  "use strict";
  var _unescapedStringInterpolationMeta = _interopRequireDefault2(require_unescaped_string_interpolation_meta());
