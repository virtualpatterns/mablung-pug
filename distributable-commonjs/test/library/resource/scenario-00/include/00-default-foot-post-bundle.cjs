(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/include/00-default-foot.cjs
  var require_default_foot = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/include/00-default-foot-pre-bundle.cjs
  "use strict";
  var _defaultFoot = _interopRequireDefault2(require_default_foot());
