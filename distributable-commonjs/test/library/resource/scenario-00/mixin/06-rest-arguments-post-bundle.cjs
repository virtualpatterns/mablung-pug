(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/06-rest-arguments.cjs
  var require_rest_arguments = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/mixin/06-rest-arguments-pre-bundle.cjs
  "use strict";
  var _restArguments = _interopRequireDefault2(require_rest_arguments());
