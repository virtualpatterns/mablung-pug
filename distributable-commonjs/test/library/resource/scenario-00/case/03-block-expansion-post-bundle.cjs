(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/case/03-block-expansion.cjs
  ...
  // distributable-commonjs/test/library/resource/scenario-00/case/03-block-expansion-pre-bundle.cjs
  "use strict";
