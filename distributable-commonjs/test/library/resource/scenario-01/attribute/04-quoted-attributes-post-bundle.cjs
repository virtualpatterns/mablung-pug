(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-01/attribute/04-quoted-attributes.cjs
  var require_quoted_attributes = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-01/attribute/04-quoted-attributes-pre-bundle.cjs
  "use strict";
  var _quotedAttributes = _interopRequireDefault2(require_quoted_attributes());
