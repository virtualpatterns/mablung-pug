(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/attribute/11-class-attribute-object-current-browser.js
  const utility = __toModule(require_utility());
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      const __node = [];
      var currentUrl = "/about";
      __utility2.addNode(__utility2.createNode("a", (() => {
        const __attribute = {};
        __utility2.addAttribute("class", {active: currentUrl === "/"}, __attribute);
        return __attribute;
      })(), (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.convertToNode("Home"), __node2);
        return __node2;
      })()), __node);
      __utility2.addNode("", __node);
      __utility2.addNode("\n", __node);
      __utility2.addNode("", __node);
      __utility2.addNode(__utility2.createNode("a", (() => {
        const __attribute = {};
        __utility2.addAttribute("class", {active: currentUrl === "/about"}, __attribute);
        return __attribute;
      })(), (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.convertToNode("About"), __node2);
        return __node2;
      })()), __node);
  ...
  function class_attribute_object_current_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/attribute/11-class-attribute-object-current-browser-pre.js
  let local = {};
  let node = class_attribute_object_current_browser_default(local);
