(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-01/filter/02-nested-filter.js
  ...
  function nested_filter_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-01/filter/02-nested-filter-pre-bundle.js
  let div = document.querySelector("body div");
  let node = nested_filter_default({});
