(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/case/02-case-fall-through-break-browser.js
  ...
  function case_fall_through_break_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/case/02-case-fall-through-break-browser-pre.js
  let local = {};
  let node = case_fall_through_break_browser_default(local);
