(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/include/00-default-foot-browser.cjs
  var require_default_foot_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/include/00-default-foot-browser-pre.cjs
  "use strict";
  var _defaultFootBrowser = _interopRequireDefault2(require_default_foot_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _defaultFootBrowser.default)(local);
