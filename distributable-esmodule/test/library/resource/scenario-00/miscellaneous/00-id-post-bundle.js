(() => {
  ...
  var require_build = __commonJS((exports2) => {
    ...
    var htmlToHs2 = curry(function(opts, html) {
      ...
      var renderSelector = function renderSelector2(depth, node2) {
        var id2 = (findByName("id", node2.attrs) || {}).value;
        var className = (findByName("className", node2.attrs) || {}).value;
        var idSelector = id2 ? "#" + id2 : "";
  ...
  // distributable-esmodule/test/library/resource/scenario-00/miscellaneous/00-id.js
  ...
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("div", (() => {
        const __attribute = {};
        __utility2.addAttribute("id", "123", __attribute);
        return __attribute;
      })(), []), __node);
  ...
  function id_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/miscellaneous/00-id-pre-bundle.js
