(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/01-each-index.cjs
  var require_each_index = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/01-each-index-pre-bundle.cjs
  "use strict";
  var _eachIndex = _interopRequireDefault2(require_each_index());
