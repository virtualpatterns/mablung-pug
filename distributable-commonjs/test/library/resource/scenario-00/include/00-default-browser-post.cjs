(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/include/00-default-browser.cjs
  var require_default_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/include/00-default-browser-pre.cjs
  "use strict";
  var _defaultBrowser = _interopRequireDefault2(require_default_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _defaultBrowser.default)(local);
