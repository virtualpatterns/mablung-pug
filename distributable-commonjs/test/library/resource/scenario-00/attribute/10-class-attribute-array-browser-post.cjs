(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/10-class-attribute-array-browser.cjs
  var require_class_attribute_array_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/10-class-attribute-array-browser-pre.cjs
  "use strict";
  var _classAttributeArrayBrowser = _interopRequireDefault2(require_class_attribute_array_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _classAttributeArrayBrowser.default)(local);
