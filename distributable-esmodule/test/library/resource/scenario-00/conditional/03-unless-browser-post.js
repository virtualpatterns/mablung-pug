(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/conditional/03-unless-browser.js
    ...
    function __getNode2(__utility2 = {}) {
      ...
      if (!user.isAnonymous) {
        __utility2.addNode(__utility2.createNode("p", {}, (() => {
          const __node2 = [];
          __utility2.addNode(__utility2.convertToNode("You're logged in as "), __node2);
          {
            let value = user.name;
            if (typeof value === "string") {
  ...
  function unless_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/conditional/03-unless-browser-pre.js
  let local = {};
  let node = unless_browser_default(local);
