(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/comment/01-default-unbuffered-browser.js
  ...
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("p", {}, (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.convertToNode("foo"), __node2);
        return __node2;
      })()), __node);
      __utility2.addNode(__utility2.createNode("p", {}, (() => {
        const __node2 = [];
        __utility2.addNode(__utility2.convertToNode("bar"), __node2);
        return __node2;
      })()), __node);
  ...
  function default_unbuffered_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/comment/01-default-unbuffered-browser-pre.js
  let local = {};
  let node = default_unbuffered_browser_default(local);
