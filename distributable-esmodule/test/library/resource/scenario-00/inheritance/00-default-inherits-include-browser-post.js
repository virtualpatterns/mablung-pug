(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/inheritance/00-default-inherits-include-browser.js
  ...
  function default_inherits_include_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/inheritance/00-default-inherits-include-browser-pre.js
  let local = {};
  let node = default_inherits_include_browser_default(local);
