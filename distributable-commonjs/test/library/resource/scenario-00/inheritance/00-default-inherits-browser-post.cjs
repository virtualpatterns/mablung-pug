(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/00-default-inherits-browser.cjs
  var require_default_inherits_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/inheritance/00-default-inherits-browser-pre.cjs
  "use strict";
  var _defaultInheritsBrowser = _interopRequireDefault2(require_default_inherits_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _defaultInheritsBrowser.default)(local);
