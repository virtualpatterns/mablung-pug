(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/04-each-else-browser.cjs
  var require_each_else_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/04-each-else-browser-pre.cjs
  "use strict";
  var _eachElseBrowser = _interopRequireDefault2(require_each_else_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _eachElseBrowser.default)(local);
