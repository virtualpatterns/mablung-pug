(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/case/03-block-expansion-browser.js
    ...
    function __getNode2(__utility2 = {}) {
      ...
      switch (friends) {
        ...
        case 1:
          __utility2.addNode(__utility2.createNode("p", {}, (() => {
            const __node2 = [];
            __utility2.addNode(__utility2.convertToNode("you have a friend"), __node2);
            return __node2;
          })()), __node);
          break;
        default:
  ...
  // distributable-esmodule/test/library/resource/scenario-00/case/03-block-expansion-browser-pre.js
  let local = {};
