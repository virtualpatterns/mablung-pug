(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-01/attribute/18-innerText-browser.cjs
  var require_innerText_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-01/attribute/18-innerText-browser-pre.cjs
  "use strict";
  var _innerTextBrowser = _interopRequireDefault2(require_innerText_browser());
