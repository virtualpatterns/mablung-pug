(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-01/attribute/18-innerText-browser.js
  ...
  function __getNode(__local = {}, __utility = {}) {
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("div", (() => {
        const __attribute = {};
        __utility2.addAttribute("innerText", "innerText", __attribute);
        return __attribute;
      })(), []), __node);
  ...
  function innerText_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-01/attribute/18-innerText-browser-pre.js
  let local = {};
  let node = innerText_browser_default(local);
