(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/interpolation/06-whitespace-control-browser.js
    ...
    function __getNode2(__utility2 = {}) {
      ...
      __utility2.addNode(__utility2.createNode("div", {}, (() => {
        ...
        __utility2.addNode(__utility2.createNode("p", {}, (() => {
          const __node3 = [];
          __utility2.addNode(__utility2.convertToNode("If I don't write the paragraph with tag interpolation, tags like"), __node3);
          __utility2.addNode(__utility2.createNode("strong", {}, (() => {
            const __node4 = [];
            __utility2.addNode(__utility2.convertToNode("strong"), __node4);
            return __node4;
          })()), __node3);
          __utility2.addNode(__utility2.convertToNode("and"), __node3);
          __utility2.addNode(__utility2.createNode("em", {}, (() => {
            const __node4 = [];
            __utility2.addNode(__utility2.convertToNode("em"), __node4);
            return __node4;
          })()), __node3);
          __utility2.addNode(__utility2.convertToNode("might produce unexpected results."), __node3);
          return __node3;
        })()), __node2);
        __utility2.addNode(__utility2.createNode("p", {}, (() => {
          const __node3 = [];
          __utility2.addNode(__utility2.convertToNode("If I do, whitespace is "), __node3);
          __utility2.addNode(__utility2.createNode("strong", {}, (() => {
            const __node4 = [];
            __utility2.addNode(__utility2.convertToNode("respected"), __node4);
            return __node4;
          })()), __node3);
          __utility2.addNode(__utility2.convertToNode(" and "), __node3);
          __utility2.addNode(__utility2.createNode("em", {}, (() => {
            const __node4 = [];
            __utility2.addNode(__utility2.convertToNode("everybody"), __node4);
            return __node4;
          })()), __node3);
          __utility2.addNode(__utility2.convertToNode(" is happy."), __node3);
          return __node3;
        })()), __node2);
        return __node2;
      })()), __node);
  ...
  function whitespace_control_browser_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/interpolation/06-whitespace-control-browser-pre.js
  let local = {};
  let node = whitespace_control_browser_default(local);
