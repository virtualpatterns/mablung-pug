(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/05-attribute-interpolation-browser.cjs
  var require_attribute_interpolation_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/05-attribute-interpolation-browser-pre.cjs
  "use strict";
  var _attributeInterpolationBrowser = _interopRequireDefault2(require_attribute_interpolation_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _attributeInterpolationBrowser.default)(local);
