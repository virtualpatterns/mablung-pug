(() => {
  ...
  // distributable-esmodule/test/library/resource/scenario-00/inheritance/01-additional-block-inherits.js
  ...
  function additional_block_inherits_default(__local = {}, __utility = utility.Utility) {
    return __getNode(__local, __utility);
  }

  // distributable-esmodule/test/library/resource/scenario-00/inheritance/01-additional-block-inherits-pre-bundle.js
  let div = document.querySelector("body div");
  let node = additional_block_inherits_default({});
