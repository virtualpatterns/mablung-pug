(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/15-id-literal-div-browser.cjs
  var require_id_literal_div_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/15-id-literal-div-browser-pre.cjs
  "use strict";
  var _idLiteralDivBrowser = _interopRequireDefault2(require_id_literal_div_browser());
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : {default: obj};
  }
  let local = {};
  let node = (0, _idLiteralDivBrowser.default)(local);
