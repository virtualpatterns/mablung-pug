(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/05-while-browser.cjs
  var require_while_browser = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/iteration/05-while-browser-pre.cjs
  "use strict";
  var _whileBrowser = _interopRequireDefault2(require_while_browser());
