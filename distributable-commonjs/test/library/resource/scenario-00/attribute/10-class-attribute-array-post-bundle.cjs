(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/10-class-attribute-array.cjs
  var require_class_attribute_array = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/attribute/10-class-attribute-array-pre-bundle.cjs
  "use strict";
  var _classAttributeArray = _interopRequireDefault2(require_class_attribute_array());
