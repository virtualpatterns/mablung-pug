(() => {
  ...
  // distributable-commonjs/test/library/resource/scenario-00/miscellaneous/04-colspan.cjs
  var require_colspan = __commonJS((exports2) => {
    "use strict";
  ...
  // distributable-commonjs/test/library/resource/scenario-00/miscellaneous/04-colspan-pre-bundle.cjs
  "use strict";
  var _colspan = _interopRequireDefault2(require_colspan());
